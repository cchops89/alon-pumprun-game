...
#endif`,Ab="gl_FragColor = linearToOutputTexel( gl_FragColor );",Tb=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function Nd(){return new Vt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xu(),fragmentShader:`
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function Ud(){return new Vt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xu(),fragmentShader:`
	...
	`}function Fv(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===hh||c===uh,h=c===Yr||c===Kr;if(l||h){let u=e.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new Id(i)),u=l?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const f=o.image;return l&&f&&f.height>0||h&&f&&s(f)?(t===null&&(t=new Id(i)),u=l?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let c=0;const l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Bv(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&gu("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function zv(i,e,t,n){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const b=d.morphAttributes[g];for(let m=0,p=b.length;m<p;m++)e.remove(b[m])}d.removeEventListener("dispose",a),delete s[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const b=f[g];for(let m=0,p=b.length;m<p;m++)e.update(b[m],i.ARRAY_BUFFER)}}function l(u){const d=[],f=u.index,g=u.attributes.position;let b=0;if(f!==null){const x=f.array;b=f.version;for(let v=0,M=x.length;v<M;v+=3){const C=x[v+0],_=x[v+1],S=x[v+2];d.push(C,_,_,S,S,C)}}else if(g!==void 0){const x=g.array;b=g.version;for(let v=0,M=x.length/3-1;v<M;v+=3){const C=v+0,_=v+1,S=v+2;d.push(C,_,_,S,S,C)}}else return;const m=new(wp(d)?Pp:Cp)(d,1);m.version=b;const p=r.get(u);p&&e.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function kv(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function c(d,f){i.drawElements(n,f,r,d*a),t.update(f,n,1)}function l(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*a,g),t.update(f,n,g))}function h(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function u(d,f,g,b){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)l(d[p]/a,f[p],b[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,b,0,g);let p=0;for(let x=0;x<g;x++)p+=f[x];for(let x=0;x<b.length;x++)t.update(p,n,b[x])}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Hv(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Gv(i,e,t){const n=new WeakMap,s=new pt;function r(a,o,c){const l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let w=function(){S.dispose(),n.delete(o),o.removeEventListener("dispose",w)};d!==void 0&&d.texture.dispose();const f=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,b=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],x=o.morphAttributes.color||[];let v=0;f===!0&&(v=1),g===!0&&(v=2),b===!0&&(v=3);let M=o.attributes.position.count*v,C=1;M>e.maxTextureSize&&(C=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);const _=new Float32Array(M*C*4*u),S=new Tp(_,M,C,u);S.type=$n,S.needsUpdate=!0;const E=v*4;for(let y=0;y<u;y++){const P=m[y],N=p[y],D=x[y],B=M*C*4*y;for(let W=0;W<P.count;W++){const V=W*E;f===!0&&(s.fromBufferAttribute(P,W),_[B+V+0]=s.x,_[B+V+1]=s.y,_[B+V+2]=s.z,_[B+V+3]=0),g===!0&&(s.fromBufferAttribute(N,W),_[B+V+4]=s.x,_[B+V+5]=s.y,_[B+V+6]=s.z,_[B+V+7]=0),b===!0&&(s.fromBufferAttribute(D,W),_[B+V+8]=s.x,_[B+V+9]=s.y,_[B+V+10]=s.z,_[B+V+11]=D.itemSize===4?s.w:1)}}d={count:u,texture:S,size:new Z(M,C)},n.set(o,d),o.addEventListener("dispose",w)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let f=0;for(let b=0;b<l.length;b++)f+=l[b];const g=o.morphTargetsRelative?1:1-f;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function Vv(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(s.get(u)!==l&&(e.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function a(){s=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}class Up extends Ut{constructor(e,t,n,s,r,a,o,c,l,h=kr){if(h!==kr&&h!==Qr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===kr&&(n=qs),n===void 0&&h===Qr&&(n=Jr),super(null,s,r,a,o,c,h,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:cn,this.minFilter=c!==void 0?c:cn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Op=new Ut,Od=new Up(1,1),Fp=new Tp,Bp=new Pg,zp=new Dp,Fd=[],Bd=[],zd=new Float32Array(16),kd=new Float32Array(9),Hd=new Float32Array(4);function oa(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Fd[s];if(r===void 0&&(r=new Float32Array(s),Fd[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Zt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function $t(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function jc(i,e){let t=Bd[e];t===void 0&&(t=new Int32Array(e),Bd[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Wv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Xv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Zt(t,e))return;i.uniform2fv(this.addr,e),$t(t,e)}}function jv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Zt(t,e))return;i.uniform3fv(this.addr,e),$t(t,e)}}function qv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Zt(t,e))return;i.uniform4fv(this.addr,e),$t(t,e)}}function Yv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Zt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),$t(t,e)}else{if(Zt(t,n))return;Hd.set(n),i.uniformMatrix2fv(this.addr,!1,Hd),$t(t,n)}}function Kv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Zt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),$t(t,e)}else{if(Zt(t,n))return;kd.set(n),i.uniformMatrix3fv(this.addr,!1,kd),$t(t,n)}}function Jv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Zt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),$t(t,e)}else{if(Zt(t,n))return;zd.set(n),i.uniformMatrix4fv(this.addr,!1,zd),$t(t,n)}}function Qv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Zv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Zt(t,e))return;i.uniform2iv(this.addr,e),$t(t,e)}}function $v(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Zt(t,e))return;i.uniform3iv(this.addr,e),$t(t,e)}}function e_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Zt(t,e))return;i.uniform4iv(this.addr,e),$t(t,e)}}function t_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function n_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Zt(t,e))return;i.uniform2uiv(this.addr,e),$t(t,e)}}function i_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Zt(t,e))return;i.uniform3uiv(this.addr,e),$t(t,e)}}function s_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Zt(t,e))return;i.uniform4uiv(this.addr,e),$t(t,e)}}function r_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Od.compareFunction=Sp,r=Od):r=Op,t.setTexture2D(e||r,s)}function a_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Bp,s)}function o_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||zp,s)}function c_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Fp,s)}function l_(i){switch(i){case 5126:return Wv;case 35664:return Xv;case 35665:return jv;case 35666:return qv;case 35674:return Yv;case 35675:return Kv;case 35676:return Jv;case 5124:case 35670:return Qv;case 35667:case 35671:return Zv;case 35668:case 35672:return $v;case 35669:case 35673:return e_;case 5125:return t_;case 36294:return n_;case 36295:return i_;case 36296:return s_;case 35678:case 36198:case 36298:case 36306:case 35682:return r_;case 35679:case 36299:case 36307:return a_;case 35680:case 36300:case 36308:case 36293:return o_;case 36289:case 36303:case 36311:case 36292:return c_}}function h_(i,e){i.uniform1fv(this.addr,e)}function u_(i,e){const t=oa(e,this.size,2);i.uniform2fv(this.addr,t)}function d_(i,e){const t=oa(e,this.size,3);i.uniform3fv(this.addr,t)}function f_(i,e){const t=oa(e,this.size,4);i.uniform4fv(this.addr,t)}function p_(i,e){const t=oa(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function m_(i,e){const t=oa(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function g_(i,e){const t=oa(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function b_(i,e){i.uniform1iv(this.addr,e)}function x_(i,e){i.uniform2iv(this.addr,e)}function v_(i,e){i.uniform3iv(this.addr,e)}function __(i,e){i.uniform4iv(this.addr,e)}function M_(i,e){i.uniform1uiv(this.addr,e)}function y_(i,e){i.uniform2uiv(this.addr,e)}function S_(i,e){i.uniform3uiv(this.addr,e)}function w_(i,e){i.uniform4uiv(this.addr,e)}function A_(i,e,t){const n=this.cache,s=e.length,r=jc(t,s);Zt(n,r)||(i.uniform1iv(this.addr,r),$t(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||Op,r[a])}function T_(i,e,t){const n=this.cache,s=e.length,r=jc(t,s);Zt(n,r)||(i.uniform1iv(this.addr,r),$t(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Bp,r[a])}function E_(i,e,t){const n=this.cache,s=e.length,r=jc(t,s);Zt(n,r)||(i.uniform1iv(this.addr,r),$t(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||zp,r[a])}function R_(i,e,t){const n=this.cache,s=e.length,r=jc(t,s);Zt(n,r)||(i.uniform1iv(this.addr,r),$t(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Fp,r[a])}function C_(i){switch(i){case 5126:return h_;case 35664:return u_;case 35665:return d_;case 35666:return f_;case 35674:return p_;case 35675:return m_;case 35676:return g_;case 5124:case 35670:return b_;case 35667:case 35671:return x_;case 35668:case 35672:return v_;case 35669:case 35673:return __;case 5125:return M_;case 36294:return y_;case 36295:return S_;case 36296:return w_;case 35678:case 36198:case 36298:case 36306:case 35682:return A_;case 35679:case 36299:case 36307:return T_;case 35680:case 36300:case 36308:case 36293:return E_;case 36289:case 36303:case 36311:case 36292:return R_}}class P_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=l_(t.type)}}class L_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=C_(t.type)}}class I_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Bl=/(\w+)(\])?(\[|\.)?/g;function Gd(i,e){i.seq.push(e),i.map[e.id]=e}function D_(i,e,t){const n=i.name,s=n.length;for(Bl.lastIndex=0;;){const r=Bl.exec(n),a=Bl.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Gd(t,l===void 0?new P_(o,i,e):new L_(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new I_(o),Gd(t,u)),t=u}}}class oc{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);D_(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Vd(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const N_=37297;let U_=0;function O_(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function F_(i){const e=tt.getPrimaries(tt.workingColorSpace),t=tt.getPrimaries(i);let n;switch(e===t?n="":e===Mc&&t===_c?n="LinearDisplayP3ToLinearSRGB":e===_c&&t===Mc&&(n="LinearSRGBToLinearDisplayP3"),i){case ln:case Vc:return[n,"LinearTransferOETF"];case bt:case pu:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Wd(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+O_(i.getShaderSource(e),a)}else return s}function B_(i,e){const t=F_(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function z_(i,e){let t;switch(e){case rp:t="Linear";break;case ap:t="Reinhard";break;case op:t="OptimizedCineon";break;case ru:t="ACESFilmic";break;case cp:t="AgX";break;case lp:t="Neutral";break;case V0:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function k_(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ca).join(`
`)}function H_(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function G_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ca(i){return i!==""}function Xd(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function jd(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const V_=/^[ \t]*#include +<([\w\d./]+)>/gm;function kh(i){return i.replace(V_,X_)}const W_=new Map;function X_(i,e){let t=Ve[e];if(t===void 0){const n=W_.get(e);if(n!==void 0)t=Ve[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return kh(t)}const j_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function qd(i){return i.replace(j_,q_)}function q_(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Yd(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Y_(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===np?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===ip?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Ci&&(e="SHADOWMAP_TYPE_VSM"),e}function K_(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Yr:case Kr:e="ENVMAP_TYPE_CUBE";break;case Gc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function J_(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Kr:e="ENVMAP_MODE_REFRACTION";break}return e}function Q_(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case sp:e="ENVMAP_BLENDING_MULTIPLY";break;case H0:e="ENVMAP_BLENDING_MIX";break;case G0:e="ENVMAP_BLENDING_ADD";break}return e}function Z_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function $_(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Y_(t),l=K_(t),h=J_(t),u=Q_(t),d=Z_(t),f=k_(t),g=H_(r),b=s.createProgram();let m,p,x=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class $s{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const Ly=new Xc(-1,1,1,-1,0,1);class Iy extends xt{constructor(){super(),this.setAttribute("position",new Ke([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Ke([0,2,0,0,2,0],2))}}const Dy=new Iy;class Zc{constructor(e){this._mesh=new ce(Dy,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Ly)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class tm extends $s{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof Vt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ms.clone(e.uniforms),this.material=new Vt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new Zc(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Sf extends $s{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class Ny extends $s{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class Uy{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new Z);this._width=n.width,this._height=n.height,t=new Un(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:ei}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new tm(em),this.copyPass.material.blending=Vi,this.clock=new $p}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),c=this.renderer.state.buffers.stencil;c.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),c.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Sf!==void 0&&(a instanceof Sf?n=!0:a instanceof Ny&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Z);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Oy extends $s{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new pe}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const Fy={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new pe(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}ia.BlurDirectionX=new Z(1,0);ia.BlurDirectionY=new Z(0,1);const By={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    }`});ri.addPass(Bs);const Cs=Bs.uniforms,Uu={base:{exposure:1.16,bloom:.6,con:1,sat:1.08,lift:.007,vig:1,grain:.055,shadow:[.01,.03,.021],hi:[.93,1.03,.99],hemi:.42,moon:1.1,rim:.9,fogFar:320},cinematic:{exposure:1.08,bloom:.52,con:1.14,sat:1.04,lift:.01,vig:1.22,grain:.06,shadow:[.006,.026,.03],hi:[1.05,1.01,.9],hemi:.38,moon:1.15,rim:1.05,fogFar:300},toxic:{exposure:1.14,bloom:.78,con:1.06,sat:1.2,lift:.006,vig:.96,grain:.048,shadow:[.006,.04,.02],hi:[.9,1.06,.95],hemi:.48,moon:1.05,rim:1.15,fogFar:250},clean:{exposure:1.3,bloom:.44,con:1.08,sat:1.12,lift:.004,vig:.82,grain:.028,shadow:[.008,.022,.018],hi:[.97,1.02,1],hemi:.5,moon:1.2,rim:.85,fogFar:360}};let lc=Uu.base;function lm(i){const e=Uu[i];e&&(lc=e,Cs.uCon.value=e.con,Cs.uSat.value=e.sat,Cs.uLift.value=e.lift,Cs.uVig.value=e.vig,Cs.uGrain.value=e.grain,Cs.uShadowTint.value.set(e.shadow[0],e.shadow[1],e.shadow[2]),Cs.uHiTint.value.set(e.hi[0],e.hi[1],e.hi[2]),Iu=e.hemi,rm=e.moon,Du.intensity=e.rim)}lm("cinematic");{const i=location.search.match(/look=(\w+)/);i&&Uu[i[1]]&&lm(i[1])}function Ou(){const i=window.innerWidth<=800,e=i?Math.round(sa.clientWidth):800,t=i?Math.round(sa.clientHeight):600;e<2||t<2||(It.setSize(e,t,!1),Nt.aspect=e/t,Nt.updateProjectionMatrix(),ri.setSize(e,t))}addEventListener("resize",Ou);addEventListener("orientationchange",()=>setTimeout(Ou,120));Ou();function Ee(i,e=.85,t=0){return new Qe({color:i,roughness:e,metalness:t})}function ao(i){const e=document.createElement("canvas");e.width=e.height=128;const t=e.getContext("2d");t.fillStyle="#808080",t.fillRect(0,0,128,128),i(t);const n=new Dt(e);return n.wrapS=n.wrapT=mi,n}const AS=ao(i=>{for(let e=-128;e<256;e+=3)i.strokeStyle="rgba(255,255,255,0.18)",i.beginPath(),i.moveTo(e,0),i.lineTo(e+128,128),i.stroke(),i.strokeStyle="rgba(0,0,0,0.18)",i.beginPath(),i.moveTo(e+1.5,0),i.lineTo(e+129.5,128),i.stroke();for(let e=0;e<500;e++)i.fillStyle="rgba(0,0,0,0.12)",i.fillRect(Math.random()*128,Math.random()*128,1.5,1.5)}),Pf=ao(i=>{for(let e=0;e<128;e+=2)i.strokeStyle=e%4?"rgba(255,255,255,0.10)":"rgba(0,0,0,0.10)",i.beginPath(),i.moveTo(0,e),i.lineTo(128,e),i.stroke();for(let e=0;e<700;e++)i.fillStyle=Math.random()<.5?"rgba(255,255,255,0.08)":"rgba(0,0,0,0.08)",i.fillRect(Math.random()*128,Math.random()*128,1.2,1.2)}),Lf=ao(i=>{for(let e=0;e<900;e++){i.fillStyle=Math.random()<.5?"rgba(255,255,255,0.14)":"rgba(0,0,0,0.14)";const t=1+Math.random()*2.5;i.fillRect(Math.random()*128,Math.random()*128,t,t)}});ao(i=>{for(let e=0;e<130;e++){const t=Math.random()*128,n=Math.random()*128;i.strokeStyle=Math.random()<.5?"rgba(255,255,255,0.22)":"rgba(0,0,0,0.22)",i.beginPath(),i.moveTo(t,n),i.quadraticCurveTo(t+4,n+9,t+2,n+18),i.stroke()}});const If=ao(i=>{for(let e=0;e<260;e++){const t=Math.random()*128,n=Math.random()*128;i.strokeStyle=Math.random()<.5?"rgba(255,255,255,0.2)":"rgba(0,0,0,0.25)",i.lineWidth=1+Math.random(),i.beginPath(),i.moveTo(t,n),i.lineTo(t+(Math.random()-.5)*6,n+10+Math.random()*8),i.stroke()}});function Us(i,e,t,n,s=2,r=2){const a=new Qe({color:i,roughness:e,bumpMap:t,bumpScale:n});return a.bumpMap=t.clone(),a.bumpMap.repeat.set(s,r),a.bumpMap.needsUpdate=!0,a}function TS(i){return new At({color:i})}function ye(i,e,t,n,s,r,a=1,o=1,c=1,l=18){const h=new ce(new ii(i,l,Math.max(10,l-4)),typeof e=="object"?e:Ee(e));return h.position.set(t,n,s),h.scale.set(a,o,c),r&&r.add(h),h}function os(i,e,t,n,s,r,a,o=14){const c=new ce(new Ka(i,e,6,o),typeof t=="object"?t:Ee(t));return c.position.set(n,s,r),a&&a.add(c),c}function wt(i,e,t,n,s,r,a,o,c=16){const l=new ce(new Wn(i,e,t,c),typeof n=="object"?n:Ee(n));return l.position.set(s,r,a),o&&o.add(l),l}function ES(){const i=new Oe,e={},t=Ee(14989706,.7),n=Ee(11579568,.9),s=Ee(1843240,.85),r=Ee(15395562,.9);t.flatShading=n.flatShading=s.flatShading=r.flatShading=!0;function a(N){const D=new Oe;D.position.set(N,.95,0),i.add(D),wt(.115,.1,.44,s,0,-.3,0,D,8),wt(.1,.085,.36,s,0,-.7,.01,D,8);const B=new ce(new Ht(.16,.11,.3),Ee(1118740,.55));B.material.flatShading=!0,B.position.set(0,-.92,-.06),D.add(B),B.castShadow=!0;const W=new ce(new Ht(.17,.04,.31),r);return W.position.set(0,-.975,-.06),D.add(W),D}e.legL=a(-.15),e.legR=a(.15);const o=wt(.28,.2,.64,r,0,1.4,0,i,8);o.scale.z=.7,o.castShadow=!0;const c=wt(.3,.28,.12,r,0,1.7,0,i,8);c.scale.z=.72;const l=document.createElement("canvas");l.width=l.height=128;const h=l.getContext("2d");h.fillStyle="#e8e8e8",h.fillRect(0,0,128,128),h.fillStyle="#16181c",h.font="bold 26px Arial Black",h.textAlign="center",h.fillText("STOP",64,42),h.fillText("BEING",64,72),h.fillText("POOR",64,102);const u=new Dt(l);u.colorSpace=bt;const d=new ce(new Yi(.26,.26),new Qe({map:u,roughness:.92,transparent:!0}));d.position.set(0,1.34,-.205),d.rotation.y=Math.PI,i.add(d);function f(N){const D=new Oe;D.position.set(N,1.72,0),i.add(D),wt(.062,.055,.34,t,0,-.22,-.02,D,8),wt(.052,.048,.3,t,0,-.55,-.05,D,8);const B=new ce(new Ht(.11,.13,.07),t);return B.position.set(0,-.74,-.06),D.add(B),D}e.armL=f(-.34),e.armR=f(.34);const g=new Oe;wt(.035,.035,.3,Ee(2763312,.6,.4),0,-.1,0,g),wt(.16,.16,.05,Ee(14264338,.4,.7),0,.08,0,g);const b=new Qe({color:3800968,emissive:2883450,emissiveIntensity:.8,roughness:.3}),m=new ce(new Wn(.028,.075,1.25,8),b);m.position.y=.75,g.add(m),ye(.035,b,0,1.42,0,g),g.position.set(0,-.7,-.06),g.rotation.x=-.6,e.armR.add(g),e.bladeMat=b,wt(.09,.1,.16,t,0,1.8,0,i,8);const p=new Oe;p.position.set(0,2.12,0),i.add(p),e.head=p;const x=ye(.35,t,0,0,0,p,1,1.02,.92,16);x.castShadow=!0,ye(.07,t,-.4,-.04,0,p),ye(.07,t,.4,-.04,0,p),ye(.07,t,0,-.1,-.4,p,1,.8,.8);const v=Ee(9408399,.9);v.flatShading=!0;function M(N,D,B,W,V,j,k,re=0){const ue=new Ht(V,W,.03),fe=ue.attributes.position;for(let ke=0;ke<fe.count;ke++)fe.getY(ke)<0&&(fe.setX(ke,fe.getX(ke)*.35),fe.setZ(ke,fe.getZ(ke)*.35));ue.computeVertexNormals();const Be=new ce(ue,v);Be.position.set(N,D-W/2,B),Be.rotation.set(j,re,k),p.add(Be)}M(-.12,.06,-.27,.22,.08,.35,.1,.2),M(0,.08,-.29,.2,.08,.4,0,0),M(.12,.06,-.27,.22,.08,.35,-.1,-.2);for(const N of[-1,1])M(N*.28,.03,-.1,.4,.09,.1,N*.28,N*.1),M(N*.3,0,.06,.44,.1,.05,N*.22,0),M(N*.26,-.02,.18,.4,.09,-.1,N*.2,-N*.1);M(-.12,.05,.27,.46,.11,-.28,.06,.1),M(.12,.05,.27,.46,.11,-.28,-.06,-.1),M(0,.08,.29,.44,.11,-.32,0,0),M(-.22,.02,.2,.4,.09,-.2,.14,.15),M(.22,.02,.2,.4,.09,-.2,-.14,-.15);const C=Ee(16106776,.8);C.flatShading=!0;const _=new ce(new ii(.38,12,7,0,Math.PI*2,0,Math.PI*.5),C);_.position.set(0,.1,.02),p.add(_);const S=new ce(new ii(.385,10,6,0,Math.PI*2,0,Math.PI*.4),Ee(1710618,.9));S.position.set(0,.1,.1),S.rotation.x=-.5,p.add(S);const E=wt(.27,.31,.045,C,0,.22,-.38,p,12);E.scale.set(1.15,1,1.5),E.rotation.x=.12,ye(.05,Ee(14264338,.6),0,.48,.02,p,1,1,1,8);const w=new Qe({color:657934,roughness:.18,metalness:.4}),y=Ee(15921906,.45);y.flatShading=!0;for(const N of[-.14,.14]){const D=new ce(new Ht(.17,.1,.05),w);D.position.set(N,.03,-.33),D.rotation.y=N<0?.18:-.18,p.add(D);const B=new ce(new Ht(.185,.02,.055),y);B.position.set(N,.086,-.33),B.rotation.y=N<0?.18:-.18,p.add(B)}const P=new ce(new Ht(.09,.02,.04),y);return P.position.set(0,.05,-.35),p.add(P),i.userData.parts=e,i.scale.setScalar(.78),i}function RS(){const i=new Oe;wt(.035,.035,.3,Ee(2763312,.6,.4),0,-.1,0,i),wt(.16,.16,.05,Ee(14264338,.4,.7),0,.08,0,i);const e=new Qe({color:3800968,emissive:2883450,emissiveIntensity:.8,roughness:.3}),t=new ce(new Wn(.028,.075,1.25,8),e);return t.position.y=.75,i.add(t),ye(.035,e,0,1.42,0,i),{group:i,bladeMat:e}}const CS=new Qe({color:14605266,roughness:.5,emissive:13158588,emissiveIntensity:1.1}),$l=Ee(460810,.85);function hm(){const i=new Oe,e=Us(921619,.96,Lf,.012,2,2),t=Us(658447,.97,Lf,.012,2,2),n=Us(724240,.95,AS,.008,2,3);function s(u){const d=new Oe;d.name=u<0?"legL":"legR",d.position.set(u,1,0),i.add(d);const f=os(.088,.42,n,0,-.26,0,d,12);f.castShadow=!sn;const g=new Oe;return g.name=u<0?"shinL":"shinR",g.position.set(0,-.54,0),d.add(g),os(.07,.4,n,0,-.2,0,g,12),ye(.082,t,0,-.45,-.04,g,1.05,.5,1.7),d}s(-.13),s(.13);const r=os(.195,.62,e,0,1.4,.02,i,18);r.rotation.x=-.22,r.castShadow=!0,ye(.15,t,0,1.74,.1,i,1.15,.62,.95);function a(u){const d=new Oe;d.name=u<0?"armL":"armR",d.position.set(u,1.68,-.02),i.add(d),os(.062,.36,e,0,-.24,-.03,d,12);const f=new Oe;return f.name=u<0?"foreL":"foreR",f.position.set(0,-.5,-.04),d.add(f),os(.052,.34,t,0,-.19,-.02,f,12),ye(.062,Ee(2760472,.85),0,-.4,-.03,f),d}a(-.26),a(.26);const o=new Oe;o.name="head",o.position.set(0,1.9,-.05),i.add(o);const c=ye(.15,t,0,0,.04,o,1,1.05,.95);c.castShadow=!sn,ye(.155,CS,0,-.02,-.06,o,.95,1.2,.58,22),ye(.027,$l,-.05,.02,-.145,o,1,1.3,.5),ye(.027,$l,.05,.02,-.145,o,1,1.3,.5),ye(.016,$l,0,-.08,-.15,o,1.7,.5,.5);const l=new ce(new ii(.158,18,10,0,Math.PI*2,0,Math.PI*.52),Us(1250586,.96,Pf,.012,4,2));l.position.set(0,.06,.02),o.add(l);const h=new ce(new Ys(.146,.03,8,18),Us(1447965,.95,Pf,.014,4,1));return h.rotation.x=Math.PI/2-.15,h.position.set(0,.03,.02),o.add(h),i}let Vr=null;const PS=Math.PI;function LS(i,e,t,n){const s=Ja.findByName(i.animations,t)||Ja.findByName(i.animations,"AnimalArmature|"+t);if(!s)return null;const r=e.clipAction(s);return r.play(),r}function IS(){return Vr||(Vr=hm()),Vr.clone()}const um=40;function dm(i){const e=[];return i.traverse(t=>{t.isMesh&&e.push(t)}),e}Vr||(Vr=hm());const DS=dm(Vr),Wr=DS.map(i=>{const e=new Wp(i.geometry,i.material,um);return e.frustumCulled=!1,e.castShadow=i.castShadow,e.receiveShadow=i.receiveShadow,e.count=0,oe.add(e),e});function NS(){const i=Math.min(ct.length,um);for(let e=0;e<i;e++){const t=ct[e];t.mesh.updateWorldMatrix(!0,!0);const n=t.leaves;for(let s=0;s<n.length;s++)Wr[s].setMatrixAt(e,n[s].matrixWorld)}for(const e of Wr)e.count=i,e.instanceMatrix.needsUpdate=!0}function US(){for(const i of Wr)i.count=0}function OS(){const i=new Oe,e={},t=Us(2826265,.95,If,.02,4,4),n=Us(2037520,.98,If,.024,4,4),s=Ee(7031347,.78),r=ye(1,t,0,2.1,.2,i,1.7,1.35,2.5,28);r.castShadow=!0,ye(1,n,0,3,-.7,i,1.3,.95,1.3,24),ye(1,n,0,1.35,-1.6,i,.85,.75,.7,22),ye(1,t,0,2,1.9,i,1.25,1.05,1,24),ye(.5,n,0,3.15,.6,i,.55,.35,2.2,18),ye(.4,t,0,1.15,-1.9,i,.6,.8,.45,18),ye(.62,t,-.95,2,1.5,i,.75,.95,1,20),ye(.62,t,.95,2,1.5,i,.75,.95,1,20),ye(.55,n,-1,2.15,-1,i,.7,.9,.9,20),ye(.55,n,1,2.15,-1,i,.7,.9,.9,20);function a(l,h,u){const d=new Oe;return d.position.set(l,1.7,h),i.add(d),os(u,.9,t,0,-.6,0,d),os(u*.62,.5,n,0,-1.35,.02,d),wt(u*.75,u*.85,.25,Ee(4867390,.7),0,-1.72,0,d),d}e.legFL=a(-.85,-1.35,.34),e.legFR=a(.85,-1.35,.34),e.legBL=a(-.8,1.7,.38),e.legBR=a(.8,1.7,.38);const o=new Oe;o.position.set(0,3.3,-2.3),i.add(o),e.head=o;const c=ye(.72,n,0,0,.1,o,1,1.05,.95,26);c.castShadow=!0,ye(.5,s,0,-.18,-.42,o,.78,1.05,.6,24),ye(.12,s,0,-.42,-.72,o,1,.8,.9,16),ye(.035,Ee(1182728,.6),-.055,-.46,-.79,o),ye(.035,Ee(1182728,.6),.055,-.46,-.79,o),ye(.5,Ee(1314832,.98),0,.5,.05,o,.95,.55,.85),ye(.14,t,-.72,-.15,.1,o,1,1.4,.7),ye(.14,t,.72,-.15,.1,o,1,1.4,.7),ye(.16,Ee(1314832,.95),0,-.85,-.5,o,.9,1.4,.8);for(const l of[-.2,.2])ye(.085,Ee(15261908,.5),l,-.05,-.62,o,1,.8,.5),ye(.045,new Qe({color:16734780,emissive:16727070,emissiveIntensity:2.2}),l,-.05,-.68,o);ye(.09,Ee(2365970,.9),-.2,.14,-.6,o,1.4,.5,.5),ye(.09,Ee(2365970,.9),.2,.14,-.6,o,1.4,.5,.5);for(const l of[-1,1]){const h=new ce(new Ys(.75,.14,12,28,1.7),Ee(13616306,.5));h.position.set(l*.55,.35,0),h.rotation.y=l*Math.PI/2,h.rotation.x=l*-.5,h.scale.x=l,o.add(h);const u=new ce(new xs(.13,.5,10),Ee(14998473,.5));u.position.set(l*1.28,.82,.05),u.rotation.z=l*-.8,o.add(u)}return e.tail=new Oe,e.tail.position.set(0,2.6,2.75),i.add(e.tail),os(.09,.9,n,0,-.5,.12,e.tail),ye(.17,Ee(1314832,.98),0,-1.05,.2,e.tail,1,1.4,1),e.tail.rotation.x=.5,i.userData.parts=e,i.scale.setScalar(5),i}const wn=280;function gt(i,e){const t=Math.hypot(i,e),n=Math.sin(i*.11)*Math.cos(e*.13)+Math.sin(i*.031+2)*Math.cos(e*.043)*2,s=Math.max(0,(t-wn)*.16);let r=Math.min(110,s*(1.5+Math.abs(n)));if(e<0){const o=-e*.42+1,c=Math.min(1,Math.abs(i)/o);r*=.3+.7*c*c}let a=n*.35+r;if(e<-110){const o=Math.max(0,1-Math.abs(i)/30)*Math.min(1,(-e-110)/40);a=a*(1-o)+Math.min(a,1.6)*o}return a}const Xh=new Yi(1400,1400,150,150);{const i=Xh.attributes.position;for(let e=0;e<i.count;e++)i.setZ(e,gt(i.getX(e),-i.getY(e)));Xh.computeVertexNormals()}const Ac=document.createElement("canvas");Ac.width=Ac.height=256;{const i=Ac.getContext("2d");i.fillStyle="#2c322d",i.fillRect(0,0,256,256);for(let e=0;e<2600;e++){const t=Math.random();i.fillStyle=t<.4?"#2a302b":t<.7?"#2f352f":t<.9?"#292e2a":"#333a33",i.beginPath(),i.ellipse(Math.random()*256,Math.random()*256,1.5+Math.random()*4,1+Math.random()*3,Math.random()*3,0,6.28),i.fill()}i.fillStyle="rgba(58,66,58,0.5)";for(let e=0;e<900;e++)i.fillRect(Math.random()*256,Math.random()*256,1.4,1.4)}const Tc=new Dt(Ac);Tc.wrapS=Tc.wrapT=mi;Tc.repeat.set(60,60);const Ec=document.createElement("canvas");Ec.width=Ec.height=512;{const i=Ec.getContext("2d");i.fillStyle="#000",i.fillRect(0,0,512,512),i.strokeStyle="#39ff9e",i.lineCap="round";for(let e=0;e<16;e++){let t=Math.random()*512,n=Math.random()*512,s=Math.random()*6.28;const r=7+Math.floor(Math.random()*9);i.globalAlpha=.25+Math.random()*.4,i.lineWidth=1+Math.random()*1.6,i.beginPath(),i.moveTo(t,n);for(let a=0;a<r;a++)s+=(Math.random()-.5)*1.3,t+=Math.cos(s)*22,n+=Math.sin(s)*22,i.lineTo(t,n);i.stroke()}}const Rc=new Dt(Ec);Rc.wrapS=Rc.wrapT=mi;Rc.repeat.set(11,11);const fm=new Qe({map:Tc,roughness:.98,emissive:3800990,emissiveMap:Rc,emissiveIntensity:0}),Fu=new ce(Xh,fm);Fu.rotation.x=-Math.PI/2;Fu.receiveShadow=!0;oe.add(Fu);function pm(i){const e=new wu(i,1),t=e.attributes.position;for(let s=0;s<t.count;s++){const r=.75+Math.random()*.5;t.setXYZ(s,t.getX(s)*r,t.getY(s)*(.55+Math.random()*.4),t.getZ(s)*r)}e.computeVertexNormals();const n=new ce(e,Ee(3817528,.98));return n.castShadow=n.receiveShadow=!0,n}const Df=sn?100:150,mm=Ee(3817528,.98);{const i=[];for(let e=0;e<Df;e++){const t=e<Df*.62,n=t?14+Math.random()*(wn-18):wn+4+Math.random()*70,s=Math.random()*Math.PI*2,r=pm(t?.5+Math.random()*1.4:2.5+Math.random()*6),a=Math.cos(s)*n,o=Math.sin(s)*n;if(Math.hypot(a-58,o-22)<28){r.geometry.dispose();continue}r.position.set(a,gt(a,o)+(t?.1:.3),o),r.rotation.y=Math.random()*6.28,i.push(r)}oe.add(Ks(i,mm)),i.forEach(e=>{e.geometry.dispose(),e.material.dispose()})}function FS(i,e){const t=new xs(e,i,7,4),n=t.attributes.position;for(let r=0;r<n.count;r++){const a=1+(Math.random()-.5)*.5;n.setX(r,n.getX(r)*a+Math.sin(n.getY(r)*.4)*e*.18),n.setZ(r,n.getZ(r)*a)}t.computeVertexNormals();const s=new ce(t,Ee(2567464,.98));return s.castShadow=s.receiveShadow=!0,s}const BS=Ee(2567464,.98);{const i=[];for(let e=0;e<(sn?16:26);e++){const t=Math.random()*Math.PI*2,n=e%3===0,s=n?60+Math.random()*(wn-80):wn-10+Math.random()*80,r=Math.cos(t)*s,a=Math.sin(t)*s;if(Bu(r,a)&&!n||Math.hypot(r-58,a-22)<34)continue;const o=n?7+Math.random()*10:14+Math.random()*26,c=FS(o,o*(.16+Math.random()*.08));c.position.set(r,gt(r,a)+o*.42,a),c.rotation.y=Math.random()*6.28,c.rotation.z=(Math.random()-.5)*.14,i.push(c)}oe.add(Ks(i,BS)),i.forEach(e=>{e.geometry.dispose(),e.material.dispose()})}let jh=null;{let u=function(m,p,x,v){const M=new ce(new Wn(x*.55,x,v,8),a);M.position.set(m,16+v/2,p),c.push(M);const C=new ce(new xs(x*.75,v*.4,8),a);C.position.set(m,16+v+v*.18,p),c.push(C);for(let _=0;_<4;_++){const S=new ce(new Yi(x*.7,v*.1),o);S.position.set(m,19+_*v*.2,p+x+.3),l.push(S)}};const i=document.createElement("canvas");i.width=i.height=128;const e=i.getContext("2d"),t=e.createRadialGradient(64,64,4,64,64,64);t.addColorStop(0,"rgba(130,255,180,1)"),t.addColorStop(.35,"rgba(70,220,130,0.5)"),t.addColorStop(1,"rgba(30,120,70,0)"),e.fillStyle=t,e.fillRect(0,0,128,128);const n=new Dt(i);n.colorSpace=bt;const s=new ji(new gi({map:n,transparent:!0,fog:!1,depthWrite:!1}));s.scale.set(300,215,1),s.position.set(0,64,-740),oe.add(s);const r=new Oe,a=new At({color:660496,fog:!1}),o=new At({color:3909738,fog:!1}),c=[],l=[],h=new ce(new xs(22,12,20),a);h.position.y=-2,c.push(h),u(0,0,10,26),u(-17,6,7,17),u(16,4,7.5,20),u(-9,-8,6,14),u(10,-10,6.5,16),u(-26,-2,5,10),u(25,-4,5,12),u(-34,-6,4,8),u(33,-8,4.5,9);const d=new ce(new ii(4.5,16,12),new At({color:7143344,fog:!1}));d.position.set(0,46,2);const f={castShadow:!1,receiveShadow:!1},g=Ks(c,a,f),b=Ks(l,o,f);c.forEach(m=>m.geometry.dispose()),l.forEach(m=>m.geometry.dispose()),r.add(g,b,d),r.scale.setScalar(1.4),r.position.set(0,-20,-258),oe.add(r),jh=r}const gm=[];function zS(){const i=document.createElement("canvas");i.width=128,i.height=256;const e=i.getContext("2d"),t=document.createElement("canvas");t.width=128,t.height=256;const n=t.getContext("2d");n.fillStyle="#000",n.fillRect(0,0,128,256),e.fillStyle="#181d1a",e.fillRect(0,0,128,256);for(let a=14;a<244;a+=24)for(let o=8;o<120;o+=22){const c=Math.random()<.3,l=!c&&Math.random()<.13;e.fillStyle=c?"#060807":l?"#d8e8b0":"#242b26",e.fillRect(o,a,14,15),l&&(n.fillStyle="#ffefa8",n.fillRect(o,a,14,15))}const s=new Dt(i);s.colorSpace=bt;const r=new Dt(t);return r.colorSpace=bt,{map:s,emissiveMap:r}}const Cc=[];for(let i=0;i<4;i++){const e=zS(),t=new Qe({map:e.map,emissiveMap:e.emissiveMap,emissive:16771488,emissiveIntensity:.9,roughness:.95});t.userData.flicker={t:Math.random()*4,on:!0},gm.push(t),Cc.push(t)}function bm(i){const e=new Oe,t=10+Math.random()*7,n=10+Math.random()*7,s=26+Math.random()*26,r=Cc[i],a=new ce(new Ht(t,s,n),r);a.position.y=s/2,e.add(a);const o=new ce(new Ht(t*(.5+Math.random()*.4),3+Math.random()*4,n*.8),r);o.position.set((Math.random()-.5)*t*.3,s+1.4,(Math.random()-.5)*2),o.rotation.z=(Math.random()-.5)*.35,o.rotation.x=(Math.random()-.5)*.2,e.add(o);for(let c=0;c<3;c++){const l=pm(1+Math.random()*1.6);l.position.set((Math.random()-.5)*(t+6),.2,(Math.random()-.5)*(n+6)),e.add(l)}return e}function Bu(i,e){return e<-30&&Math.abs(i)<e*-.45}const zu=[],Nf=sn?18:24;for(let i=0;i<Nf;i++){const e=i/Nf*Math.PI*2+Math.random()*.22,t=wn+10+Math.random()*44,n=Math.cos(e)*t,s=Math.sin(e)*t;if(Bu(n,s))continue;const r=bm(i%4);r.position.set(n,gt(n,s)-1.5,s),r.rotation.y=Math.random()*6.28,zu.push(r)}for(let i=0;i<(sn?9:14);i++){let e,t;do{const s=Math.random()*Math.PI*2,r=60+Math.random()*(wn-80);e=Math.cos(s)*r,t=Math.sin(s)*r}while(Bu(e,t)||Math.hypot(e-58,t-22)<34);const n=bm(i%4);n.scale.setScalar(.62),n.position.set(e,gt(e,t)-.6,t),zu.push(n)}{const i=[[],[],[],[]],e=[];for(const t of zu)t.updateMatrixWorld(!0),t.traverse(n=>{if(!n.isMesh)return;const s=Cc.indexOf(n.material);s>=0?i[s].push(n):e.push(n)});for(let t=0;t<4;t++)i[t].length&&oe.add(Ks(i[t],Cc[t],{world:!0}));e.length&&oe.add(Ks(e,mm,{world:!0})),i.flat().forEach(t=>t.geometry.dispose()),e.forEach(t=>{t.geometry.dispose(),t.material.dispose()})}const za=[],qh=[];for(let i=0;i<5;i++){const e=new Qc(16753984,0,15,1.8);oe.add(e),qh.push(e)}const kS=Ee(1842973,.6,.5),HS=Ee(1316378,.7,.4),GS=TS(16761963),VS=Ee(1053204,.8),xm=[];function vm(){const i=new Oe;wt(.07,.1,3.2,kS,0,1.6,0,i,10),wt(.16,.2,.5,HS,0,3.35,0,i,6),ye(.1,GS,0,3.33,0,i);const e=new ce(new xs(.26,.22,6),VS);return e.position.y=3.68,i.add(e),xm.push(i),i}function _m(i,e,t){za.push({x:i,y:e+3.35,z:t,color:16753984,base:26,range:15,cull2:15*15*2.5,ph:Math.random()*6.28})}for(let i=0;i<(sn?22:36);i++){const e=i*2.399+.2,t=18+i%6*44+Math.random()*14,n=Math.cos(e)*t,s=Math.sin(e)*t;if(Math.hypot(n-58,s-22)<26)continue;const r=vm(),a=gt(n,s)-.05;r.position.set(n,a,s),_m(n,a,s)}function WS(){const i=new Map;for(const e of xm)e.updateMatrixWorld(!0),e.traverse(t=>{t.isMesh&&(i.get(t.material)||i.set(t.material,[]).get(t.material)).push(t)});for(const[e,t]of i)oe.add(Ks(t,e,{world:!0,castShadow:!1})),t.forEach(n=>n.geometry.dispose())}const Mm=[];{const i=document.createElement("canvas");i.width=i.height=64;const e=i.getContext("2d"),t=e.createRadialGradient(32,32,3,32,32,32);t.addColorStop(0,"rgba(190,255,210,1)"),t.addColorStop(.35,"rgba(80,230,140,0.7)"),t.addColorStop(1,"rgba(20,120,60,0)"),e.fillStyle=t,e.fillRect(0,0,64,64);const n=new Dt(i);n.colorSpace=bt;for(let s=0;s<(sn?18:30);s++){const r=Math.random()*Math.PI*2,a=25+Math.random()*(wn+60),o=new ji(new gi({map:n,transparent:!0,depthWrite:!1})),c=2.2+Math.random()*3.4,l=Math.cos(r)*a,h=Math.sin(r)*a;o.position.set(l,gt(l,h)+c*.4,h),o.scale.set(c,c*1.4,1),oe.add(o),Mm.push({s:o,sc:c,ph:Math.random()*6.28}),za.push({x:l,y:o.position.y+1,z:h,color:4186250,base:18,range:20,cull2:20*20*2.5,ph:Math.random()*6.28})}}const Nn=[];function ka(i,e){const t=document.createElement("canvas");t.width=t.height=128;const n=t.getContext("2d");n.fillStyle=i,n.fillRect(0,0,128,128);for(let r=0;r<128;r+=8)n.fillStyle=e,n.fillRect(r,0,3,128);for(let r=0;r<260;r++)n.fillStyle=Math.random()<.5?"rgba(60,38,20,0.25)":"rgba(0,0,0,0.2)",n.fillRect(Math.random()*128,Math.random()*128,2+Math.random()*3,1+Math.random()*2);const s=new Dt(t);return s.colorSpace=bt,s}const $c=[new Qe({map:ka("#4a2e28","#3a221e"),roughness:.72,metalness:.06}),new Qe({map:ka("#24443c","#1a332d"),roughness:.72,metalness:.06}),new Qe({map:ka("#3e4248","#2e3238"),roughness:.72,metalness:.06})],er=new Qe({map:ka("#4a4f48","#42463f"),roughness:.78,metalness:.05});function ai(i,e,t,n,s,r){const a=gt(i,e),o=new ce(new Ht(t,n,s),r);o.position.set(i,a+n/2-.08,e),o.castShadow=o.receiveShadow=!0,oe.add(o),Nn.push({x:i,z:e,hw:t/2,hd:s/2,topY:a+n-.08})}ai(-24,-8,7.4,2.4,3.2,$c[0]);ai(18,-26,3.2,2.4,7.4,$c[1]);ai(-10,28,7.4,2.4,3.2,$c[2]);ai(30,8,3.2,2.4,7.4,$c[1]);ai(-18,10,2.6,1.4,2.6,er);ai(8,18,3,1.5,3,er);ai(12,-10,2.4,1.3,2.4,er);ai(-32,18,2.8,1.4,2.8,er);ai(2,-34,3.2,1.5,3.2,er);ai(-6,-16,2.2,1.3,2.2,er);ai(28.5,12.6,2.6,1.3,2.6,er);const An=58,Yt=22,Xt=gt(An,Yt)+.55,Pc=An-10,us=3.4,Lc=1.5,Yh=16,ym=[{x0:An+6.5,x1:An+9.5,z0:Yt-11,z1:Yt-7.4,h:(i,e)=>1.3*(Yt-7.4-e)/3.6},{x0:An+6.5,x1:An+9.5,z0:Yt+7.4,z1:Yt+11,h:(i,e)=>1.3*(e-(Yt+7.4))/3.6}];{const i=ka("#565b54","#565b54"),e=new ce(new Ht(44,1.6,34),new Qe({map:i,roughness:.97}));e.position.set(An,Xt-.8,Yt),e.receiveShadow=!0,oe.add(e);const t=30,n=2,s=[],r=[];for(let c=0;c<=n;c++){const l=-Yh/2+c/n*Yh;for(let h=0;h<=t;h++){const u=-4.9+h/t*2*(Lc+us),d=Math.abs(u)-Lc,f=d>0?us-Math.sqrt(Math.max(0,us*us-d*d)):0;s.push(Pc+u,Xt+f+.02,Yt+l)}}for(let c=0;c<n;c++)for(let l=0;l<t;l++){const h=c*(t+1)+l,u=h+1,d=h+t+1,f=d+1;r.push(h,d,u,u,d,f)}const a=new xt;a.setAttribute("position",new Ke(s,3)),a.setIndex(r),a.computeVertexNormals();const o=new ce(a,new Qe({map:i,roughness:.95,side:on}));o.receiveShadow=!0,oe.add(o);for(const c of ym){c.x1-c.x0,c.z1-c.z0;const l=1.3,h=c.h(c.x0,c.z0)>0,u=h?c.z1:c.z0,d=h?c.z0:c.z1,f=new xt;f.setAttribute("position",new Ke([c.x0,Xt,u,c.x1,Xt,u,c.x0,Xt+l,d,c.x1,Xt,u,c.x1,Xt+l,d,c.x0,Xt+l,d,c.x0,Xt,d,c.x1,Xt,d,c.x0,Xt+l,d,c.x1,Xt,d,c.x1,Xt+l,d,c.x0,Xt+l,d],3)),f.computeVertexNormals();const g=new ce(f,new Qe({map:i,roughness:.95,side:on}));g.castShadow=g.receiveShadow=!0,oe.add(g)}for(const[c,l]of[[An-20,Yt-15],[An+20,Yt+15]]){const h=vm(),u=gt(c,l)-.05;h.position.set(c,u,l),_m(c,u,l)}WS()}function Sm(){const i=new Oe,e=new ce(new Ht(.34,.05,1.05),new Qe({color:2924127,emissive:1997382,emissiveIntensity:.5,roughness:.6}));e.position.y=.12,i.add(e);const t=new ce(new Ht(.34,.05,.18),e.material);t.position.set(0,.16,.58),t.rotation.x=-.45,i.add(t);const n=new ce(new Ht(.34,.05,.18),e.material);n.position.set(0,.16,-.58),n.rotation.x=.45,i.add(n);const s=Ee(15262416,.5);for(const[r,a]of[[-.13,-.36],[.13,-.36],[-.13,.36],[.13,.36]]){const o=new ce(new Wn(.06,.06,.05,10),s);o.rotation.z=Math.PI/2,o.position.set(r,.06,a),i.add(o)}return i}const ra={x:An-2,z:Yt+13},aa=Sm();aa.rotation.set(0,.4,-1.15);aa.position.set(ra.x,Xt+.55,ra.z);oe.add(aa);const XS=wt(.06,.08,1.1,Ee(2764074,.8),ra.x-.4,Xt+.55,ra.z,null,8);oe.add(XS);const Kh=[];{const i=new ca(.5,1.1,20);for(const[e,t,n]of[[Pc,Yt-10.6,!0],[Pc,Yt+10.6,!0],[-30,40,!1],[20,-55,!1],[-60,-15,!1],[35,70,!1]]){const s=n?Xt:gt(e,t),r=new ce(i,new At({color:5504928,transparent:!0,opacity:.5,depthWrite:!1,blending:Tn,side:on}));r.rotation.x=-Math.PI/2,r.position.set(e,s+.12,t),oe.add(r),Kh.push({x:e,z:t,y:s,ring:r,ph:Math.random()*6.28})}}let Hs=null,ds=null;function jS(){const i=new Oe,e=Ee(12159578,.82),t=new ce(new Ht(1.5,.12,.9),e);t.position.y=.94,i.add(t);for(const[n,s]of[[-.62,-.34],[.62,-.34],[-.62,.34],[.62,.34]])wt(.06,.07,.9,e,n,.45,s,i,8);return ds={w:1.5,d:.9},i}function Uf(){const i=sn?[[.95,4,!1],[1.8,3,!1],[2.8,3,!0]]:[[.95,7,!1],[1.9,5,!1],[2.9,4,!0]];for(const[e,t,n]of i)for(let s=0;s<t;s++){let r,a,o=!1,c=0;for(;!o&&c++<50;){const g=Math.random()*Math.PI*2,b=12+Math.random()*66;if(r=Math.cos(g)*b,a=Math.sin(g)*b,o=Math.hypot(r-An,a-Yt)>32&&Math.hypot(r,a)>7,o){for(const m of Nn)if(Math.abs(r-m.x)<m.hw+4&&Math.abs(a-m.z)<m.hd+4){o=!1;break}}}if(!o)continue;const l=Hs.clone(),h=Math.floor(Math.random()*4);l.rotation.y=h*Math.PI/2,l.scale.setScalar(e);const u=gt(r,a);l.position.set(r,u,a),oe.add(l);const d=(h%2?ds.d:ds.w)*e,f=(h%2?ds.w:ds.d)*e;Nn.push({x:r,z:a,hw:Math.max(.8,d*.45),hd:Math.max(.8,f*.45),topY:u+e,mesh:l,baseH:e,surf:n,surfCd:0})}window.__tablesN=Nn.filter(e=>e.mesh).length,qS(),YS()}const wm=[];function qS(){const i=sn?3:5;for(let e=0;e<i;e++){const t=new Oe,n=Hs.clone();n.rotation.x=-1.25,t.add(n);const s=new si().setFromObject(n);n.position.y-=s.min.y,t.scale.setScalar(1.4+Math.random()*.8);let r,a,o=0;do{const c=Math.random()*Math.PI*2,l=18+Math.random()*66;r=Math.cos(c)*l,a=Math.sin(c)*l}while(Math.hypot(r-An,a-Yt)<32&&o++<30);t.position.set(r,gt(r,a),a),oe.add(t),wm.push({g:t,wx:r,wz:a,sp:1.1+Math.random()*.9,ph:Math.random()*6.28})}}let Tr=null,Pi=null,Jh=!1;function YS(){if(Tr||!Hs)return;Tr=new Oe,oe.add(Tr);const i=ds.w||1.6,e=ds.d||1,t=jh?jh.position.z:-250,n=12,s=t+14,r=14,a=-72,o=.4,c=22,l=s+n+1,h=r+3;let u=null;Hs.traverse(g=>{g.isMesh&&!u&&(u=g.material.clone())}),u||(u=Ee(12159578,.82)),u.emissive=new pe(1123354),u.emissiveIntensity=1;function d(g,b,m,p,x){const v=Hs.clone();v.traverse(_=>{_.isMesh&&(_.material=u)}),v.scale.setScalar(p),v.position.set(g,b-p,m),v.rotation.y=x?Math.PI/2:0,Tr.add(v);const M=Math.max(1.9,i*p*.42),C=Math.max(1.9,e*p*.42);Nn.push({x:g,z:m,hw:x?C:M,hd:x?M:C,topY:b,botY:b-2.6,pad:.7,mesh:v,baseH:p,surf:!1})}for(let g=0;g<c;g++){const b=g/(c-1),m=Math.sin(g*.8)*5,p=o+(h-o)*b+(g<2?0:Math.sin(g*1.9)*1.1),x=a+(l-a)*b,v=g===0?2.2:4.4+(Math.sin(g*1.7+.5)*.5+.5)*2.6;d(m,p,x,v,g%2===1)}for(const g of[4,9,14,18]){const b=g/(c-1),m=g%8<4?1:-1;d(m*12,o+(h-o)*b+1,a+(l-a)*b+3,4.6,g%2===0)}KS(0,a+6);const f=new ce(new Wn(n,n,2.4,24),Ee(857874,.75));f.position.set(0,r-1.2,s),Tr.add(f),Nn.push({x:0,z:s,hw:n-.6,hd:n-.6,topY:r,surf:!1}),Pi={x:0,z:s,r:n-.6,y:r},window.__tablewayOk=!0}function KS(i,e){const t=gt(i,e),n=new Oe;n.position.set(i,t,e),Tr.add(n);const s=new Qe({color:1316380,roughness:.45,metalness:.8}),r=6.5,a=8.5;for(const f of[-r,r]){wt(.3,.36,a,s,f,a/2,0,n,10);const g=new ce(new ii(.45,10,8),s);g.position.set(f,a,0),n.add(g),wt(.55,.68,.5,s,f,.25,0,n,10)}const o=new ce(new Ys(r,.28,10,44,Math.PI),s);o.position.set(0,a,0),n.add(o);const c=new ce(new Ys(r-1.5,.12,8,40,Math.PI),s);c.position.set(0,a,0),n.add(c);for(let f=1;f<8;f++){const g=f/8*Math.PI,b=new ce(new Wn(.07,.07,1.5,6),s);b.position.set(Math.cos(g)*(r-.75),a+Math.sin(g)*(r-.75),0),b.rotation.z=g-Math.PI/2,n.add(b)}const l="THE BLACK TABLEWAY",h=Math.PI*.92,u=Math.PI/2+h/2,d=r+.7;for(let f=0;f<l.length;f++){if(l[f]===" ")continue;const g=u-f/(l.length-1)*h,b=document.createElement("canvas");b.width=b.height=64;const m=b.getContext("2d");m.textAlign="center",m.textBaseline="middle",m.fillStyle="#8dffb4",m.shadowColor="#53ffa0",m.shadowBlur=6,m.font="bold 50px Arial Black",m.fillText(l[f],32,35);const p=new Dt(b);p.colorSpace=bt;const x=new ce(new Yi(1.15,1.15),new At({map:p,transparent:!0,fog:!1,depthWrite:!1}));x.position.set(Math.cos(g)*d,a+Math.sin(g)*d,.16),x.rotation.z=g-Math.PI/2,n.add(x)}}function Ii(i,e,t){let n;if(i>An-22&&i<An+22&&e>Yt-17&&e<Yt+17){n=Xt;const s=i-Pc;if(Math.abs(s)<Lc+us-.05&&Math.abs(e-Yt)<Yh/2){const r=Math.abs(s)-Lc;r>0&&(n+=us-Math.sqrt(Math.max(0,us*us-r*r)))}for(const r of ym)i>r.x0&&i<r.x1&&e>r.z0&&e<r.z1&&(n=Math.max(n,Xt+r.h(i,e)))}else n=gt(i,e);for(const s of Nn){const r=s.pad||0;Math.abs(i-s.x)<s.hw+r&&Math.abs(e-s.z)<s.hd+r&&t>=s.topY-.45&&(n=Math.max(n,s.topY))}return n}const Xr=new Vt({side:pn,depthWrite:!1,uniforms:{top:{value:new pe(263946)},bot:{value:new pe(1582364)},flash:{value:0}},vertexShader:"varying vec3 vPos; void main(){ vPos = position; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }",fragmentShader:"varying vec3 vPos; uniform vec3 top; uniform vec3 bot; uniform float flash; void main(){ float h = pow(clamp(normalize(vPos).y, 0.0, 1.0), 0.5); vec3 col = mix(bot, top, h); col = mix(col, vec3(0.72, 1.0, 0.82), flash * (0.2 + h * 0.45)); gl_FragColor = vec4(col, 1.0); }"}),da=new Oe;oe.add(da);da.add(new ce(new ii(520,24,12),Xr));const el=document.createElement("canvas");el.width=256;el.height=128;{const i=el.getContext("2d");for(let e=0;e<70;e++){const t=Math.random()*256,n=Math.random()*90,s=16+Math.random()*30,r=(.09+Math.random()*.13)*(1-n/128);for(const a of[0,-256,256]){const o=i.createRadialGradient(t+a,n,2,t+a,n,s);o.addColorStop(0,"rgba(210,240,220,"+r+")"),o.addColorStop(1,"rgba(210,240,220,0)"),i.fillStyle=o,i.beginPath(),i.arc(t+a,n,s,0,6.28),i.fill()}}}const tl=new Dt(el);tl.wrapS=mi;tl.repeat.set(4,1);const Am=new At({map:tl,transparent:!0,fog:!1,depthWrite:!1,color:1451035,side:pn}),ku=new ce(new ii(505,20,9,0,Math.PI*2,0,Math.PI*.55),Am);ku.renderOrder=1;da.add(ku);const Ic=document.createElement("canvas");Ic.width=Ic.height=128;{const i=Ic.getContext("2d"),e=i.createRadialGradient(64,64,8,64,64,64);e.addColorStop(0,"rgba(228,246,232,1)"),e.addColorStop(.22,"rgba(190,225,200,0.85)"),e.addColorStop(.3,"rgba(130,180,150,0.22)"),e.addColorStop(1,"rgba(60,110,80,0)"),i.fillStyle=e,i.fillRect(0,0,128,128)}const Tm=new Dt(Ic);Tm.colorSpace=bt;const nl=new ji(new gi({map:Tm,transparent:!0,fog:!1,depthWrite:!1}));nl.scale.set(72,72,1);nl.position.set(42,26,18).normalize().multiplyScalar(495);da.add(nl);const il=document.createElement("canvas");il.width=64;il.height=256;{const i=il.getContext("2d"),e=i.createLinearGradient(0,256,0,0);e.addColorStop(0,"rgba(110,255,170,0.45)"),e.addColorStop(.7,"rgba(80,220,140,0.1)"),e.addColorStop(1,"rgba(60,200,120,0)"),i.fillStyle=e,i.fillRect(0,0,64,256);const t=i.createLinearGradient(0,0,64,0);t.addColorStop(0,"rgba(0,0,0,1)"),t.addColorStop(.3,"rgba(0,0,0,0)"),t.addColorStop(.7,"rgba(0,0,0,0)"),t.addColorStop(1,"rgba(0,0,0,1)"),i.globalCompositeOperation="destination-out",i.fillStyle=t,i.fillRect(0,0,64,256)}const JS=new Dt(il),oo=new Oe,Em=[];for(let i=0;i<6;i++){const e=new ce(new Yi(6+Math.random()*8,65+Math.random()*40),new At({map:JS,transparent:!0,fog:!1,depthWrite:!1,blending:Tn,opacity:.4,side:on}));e.position.set(-28+Math.random()*56,48+Math.random()*18,(Math.random()-.5)*8),e.rotation.z=(Math.random()-.5)*.3,oo.add(e),Em.push({m:e,ph:Math.random()*6.28,baseZ:e.rotation.z})}oo.position.set(0,24,-575);oo.scale.setScalar(2);oe.add(oo);const Rm=[];for(let i=0;i<240;i++){const e=Math.random()*Math.PI*2,t=Math.asin(Math.random()*.9+.08);Rm.push(Math.cos(e)*Math.cos(t)*500,Math.sin(t)*500,Math.sin(e)*Math.cos(t)*500)}const Cm=new xt;Cm.setAttribute("position",new Ke(Rm,3));da.add(new Yc(Cm,new io({color:10467496,size:1.4,sizeAttenuation:!1,transparent:!0,opacity:.5,fog:!1})));const zs=[],QS=new ii(.5,8,6),Of={};function ZS(i){return Of[i]||(Of[i]=new At({color:i}))}function Kn(i,e,t,n){for(let s=0;s<n.n;s++){const r=new ce(QS,ZS(n.color)),a=n.size*(.6+Math.random()*.8);r.scale.setScalar(a);const o=n.spread||1;r.position.set(i+(Math.random()-.5)*o,e+Math.random()*.5,t+(Math.random()-.5)*o);const c=Math.random()*Math.PI*2;zs.push({m:r,s:a,smoke:!!n.smoke,vx:Math.cos(c)*n.sp*Math.random(),vz:Math.sin(c)*n.sp*Math.random(),vy:n.up*(.4+Math.random()*.8),g:n.grav,t:n.life*(.7+Math.random()*.6),life:n.life}),oe.add(r)}for(;zs.length>220;)oe.remove(zs[0].m),zs.shift()}const Hu=sn?200:380,li=70,Pm=28,Dc=document.createElement("canvas");Dc.width=Dc.height=32;{const i=Dc.getContext("2d"),e=i.createRadialGradient(16,16,1,16,16,16);e.addColorStop(0,"rgba(255,255,255,1)"),e.addColorStop(.4,"rgba(140,255,180,0.55)"),e.addColorStop(1,"rgba(0,0,0,0)"),i.fillStyle=e,i.fillRect(0,0,32,32)}const hc=new Float32Array(Hu*3),uc=[];for(let i=0;i<Hu;i++)hc[i*3]=(Math.random()-.5)*li,hc[i*3+1]=1+Math.random()*Pm,hc[i*3+2]=(Math.random()-.5)*li,uc.push({x:.5+Math.random()*.9,y:.25+Math.random()*.6,ph:Math.random()*6.28});const Gu=new xt;Gu.setAttribute("position",new Qt(hc,3));const Lm=new io({map:new Dt(Dc),color:7339935,size:.7,transparent:!0,opacity:.85,depthWrite:!1,blending:Tn}),Im=new Yc(Gu,Lm);Im.frustumCulled=!1;oe.add(Im);const sl=document.createElement("canvas");sl.width=128;sl.height=64;{const i=sl.getContext("2d"),e=i.createRadialGradient(64,32,4,64,32,62);e.addColorStop(0,"rgba(170,200,180,0.5)"),e.addColorStop(1,"rgba(170,200,180,0)"),i.fillStyle=e,i.fillRect(0,0,128,64)}const $S=new Dt(sl),Dm=[];for(let i=0;i<(sn?6:10);i++){const e=new ji(new gi({map:$S,transparent:!0,opacity:.16+Math.random()*.12,depthWrite:!1,color:3557692}));e.scale.set(30+Math.random()*26,4.5+Math.random()*2.5,1),oe.add(e),Dm.push({s:e,a:Math.random()*6.28,r:25+Math.random()*35,sp:.012+Math.random()*.02,ph:Math.random()*6.28})}const rl=200,fs=new Float32Array(rl*3).fill(9999),dc=new Float32Array(rl*3),co=new xt;co.setAttribute("position",new Qt(fs,3));co.setAttribute("color",new Qt(dc,3));const Nc=document.createElement("canvas");Nc.width=Nc.height=32;{const i=Nc.getContext("2d"),e=i.createRadialGradient(16,16,1,16,16,16);e.addColorStop(0,"rgba(255,255,255,1)"),e.addColorStop(1,"rgba(255,255,255,0)"),i.fillStyle=e,i.fillRect(0,0,32,32)}const Nm=new Yc(co,new io({map:new Dt(Nc),size:.5,transparent:!0,depthWrite:!1,blending:Tn,vertexColors:!0}));Nm.frustumCulled=!1;oe.add(Nm);const Um=[];let Ff=0;const qo=new pe;function Mn(i,e,t,n,s,r){qo.setHex(n);for(let a=0;a<s;a++){const o=Ff=(Ff+1)%rl;fs[o*3]=i,fs[o*3+1]=e,fs[o*3+2]=t,dc[o*3]=qo.r,dc[o*3+1]=qo.g,dc[o*3+2]=qo.b;const c=Math.random()*6.28;Um[o]={vx:Math.cos(c)*r*Math.random(),vy:2+Math.random()*4,vz:Math.sin(c)*r*Math.random(),t:.3+Math.random()*.25}}co.attributes.color.needsUpdate=!0}const Vu=[];{const i=new ca(.8,1,40);for(let e=0;e<3;e++){const t=new ce(i,new At({color:10475700,transparent:!0,opacity:0,depthWrite:!1,blending:Tn,side:on}));t.rotation.x=-Math.PI/2,t.visible=!1,oe.add(t),Vu.push({m:t,t:0})}}function Bf(i,e){const t=Vu.find(n=>n.t<=0);t&&(t.t=.55,t.m.visible=!0,t.m.position.set(i,gt(i,e)+.3,e))}const Yo=[];let eh=10+Math.random()*15;const Ln={next:3+Math.random()*5,env:0,restrike:0};let jt=0,Ni=null,Pa=0,Qh=.2;const Om=new qc({color:new pe(2.4,3.2,2.7),transparent:!0,opacity:0,fog:!1});function e1(){const i=Math.random()*Math.PI*2,e=80+Math.random()*70;let t=q.x+Math.cos(i)*e,n=q.z+Math.sin(i)*e,s=90+Math.random()*40;const r=[new R(t,s,n)];for(;s>0;)s-=6+Math.random()*9,t+=(Math.random()-.5)*13,n+=(Math.random()-.5)*6,r.push(new R(t,Math.max(0,s),n));Ni&&(oe.remove(Ni),Ni.geometry.dispose()),Ni=new no(new xt().setFromPoints(r),Om),oe.add(Ni),Qh=.16+Math.random()*.1,Pa=Qh}const Dn=new Oe,_t=new Oe;Dn.add(_t);let Uc=ES();_t.add(Uc);let Bi=Uc;const Xe={};let Er=!1;const t1=1.5,zf=new Vn,kf=new nn;function nt(i,e,t,n){i&&(zf.set(e,t,n),kf.setFromEuler(zf),i.quaternion.copy(i.userData.rest).multiply(kf))}const Ko=new nn,th=new nn,Hf=new R,Gf=new nn,Vf=new R;function Zh(i,e,t,n){i&&(i.parent.getWorldQuaternion(th),Ko.copy(th).multiply(i.userData.rest),Hf.set(0,1,0).applyQuaternion(Ko).normalize(),Vf.set(e,t,n).normalize(),Gf.setFromUnitVectors(Hf,Vf),Ko.premultiply(Gf),i.quaternion.copy(th.invert()).multiply(Ko))}function Ur(i,e,t,n,s){const r=Math.sin(e),a=Math.cos(e),o=Math.cos(e),c=-Math.sin(e);Zh(i,t*o*n+r*s,-1,t*c*n+a*s)}function Fm(i){const e=t=>{const n=i.getObjectByName(t);return n&&(n.userData.rest=n.quaternion.clone()),n};return{legL:e("thighL"),legR:e("thighR"),shinL:e("shinL"),shinR:e("shinR"),armL:e("upperarmL"),armR:e("upperarmR"),foreL:e("forearmL"),foreR:e("forearmR"),spine:e("spine"),head:e("head")}}const n1=(()=>{const i=document.createElement("canvas");i.width=i.height=64;const e=i.getContext("2d"),t=e.createRadialGradient(32,32,2,32,32,32);return t.addColorStop(0,"rgba(0,0,0,0.5)"),t.addColorStop(.55,"rgba(0,0,0,0.24)"),t.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=t,e.fillRect(0,0,64,64),new Dt(i)})(),i1=new so(1,24),s1=new At({map:n1,transparent:!0,depthWrite:!1}),Bm=[],al=document.createElement("canvas");al.width=16;al.height=256;{const i=al.getContext("2d"),e=i.createLinearGradient(0,256,0,0);e.addColorStop(0,"rgba(134,255,196,0.7)"),e.addColorStop(.5,"rgba(90,230,150,0.22)"),e.addColorStop(1,"rgba(70,210,130,0)"),i.fillStyle=e,i.fillRect(0,0,16,256);const t=i.createLinearGradient(0,0,16,0);t.addColorStop(0,"rgba(0,0,0,1)"),t.addColorStop(.5,"rgba(0,0,0,0)"),t.addColorStop(1,"rgba(0,0,0,1)"),i.globalCompositeOperation="destination-out",i.fillStyle=t,i.fillRect(0,0,16,256)}const r1=new Dt(al);for(let i=0;i<8;i++){const e=i/8*Math.PI*2,t=320,n=Math.cos(e)*t,s=Math.sin(e)*t,r=new ji(new gi({map:r1,transparent:!0,fog:!1,depthWrite:!1,blending:Tn,opacity:.65}));r.scale.set(16,130,1),r.position.set(n,gt(n,s)+62,s),oe.add(r)}function a1(i){for(let t=0;t<5;t++)i.load(sm,n=>{const s=n.scene,r=46+Math.random()*34;s.scale.setScalar(r),s.traverse(l=>{if(!(l.isMesh||l.isSkinnedMesh))return;l.frustumCulled=!1,l.castShadow=!1;const h=l.material;h&&h.emissive&&(h.emissive.setHex(1849898),h.emissiveIntensity=.9)});const a=Math.random()*Math.PI*2,o=292+Math.random()*60;s.position.set(Math.cos(a)*o,gt(Math.cos(a)*o,Math.sin(a)*o),Math.sin(a)*o),oe.add(s);const c=new ce(i1,s1);c.rotation.x=-Math.PI/2,c.renderOrder=1,oe.add(c),Bm.push({root:s,shadow:c,A:Fm(s),scale:r,heading:Math.random()*Math.PI*2,speed:1+Math.random()*1.4,phase:Math.random()*Math.PI*2,cadence:1+Math.random()*.4})})}function o1(i){for(const e of Bm){const t=e.root.position;e.heading+=(Math.random()-.5)*.3*i;const n=Math.hypot(t.x,t.z);if(n>360||n<286){const c=Math.atan2(-t.z,-t.x);e.heading+=Math.sin(c-e.heading)*(n>360?1:-1)*1.5*i}t.x+=Math.cos(e.heading)*e.speed*i,t.z+=Math.sin(e.heading)*e.speed*i,t.y=gt(t.x,t.z),e.shadow&&(e.shadow.position.set(t.x,t.y+.08,t.z),e.shadow.scale.setScalar(e.scale*.4)),e.root.rotation.y=Math.PI/2-e.heading,e.phase+=i*e.cadence*(.7+e.speed*.4);const s=e.phase,r=e.A,a=.7,o=e.root.rotation.y;nt(r.legL,Math.sin(s)*a,0,0),nt(r.legR,Math.sin(s+Math.PI)*a,0,0),nt(r.shinL,Math.max(0,-Math.sin(s))*.6,0,0),nt(r.shinR,Math.max(0,-Math.sin(s+Math.PI))*.6,0,0),Ur(r.armL,o,1,.16,Math.sin(s+Math.PI)*.3),Ur(r.armR,o,-1,.16,Math.sin(s)*.3),nt(r.foreL,.2,0,0),nt(r.foreR,.2,0,0),nt(r.spine,.05+Math.abs(Math.sin(s))*.05,Math.sin(s)*.14,Math.sin(s)*.05),nt(r.head,-.03,Math.sin(s)*-.08,0)}}{const i=new Pu;i.setMeshoptDecoder(Lu),i.load(sm,e=>{a1(i);const t=e.scene;t.scale.setScalar(t1),t.rotation.y=Math.PI,t.traverse(s=>{(s.isMesh||s.isSkinnedMesh)&&(s.frustumCulled=!1,s.castShadow=!0)}),Object.assign(Xe,Fm(t));const n=RS();n.group.position.set(.16,.02,.02),n.group.scale.setScalar(.42),n.group.userData.rest=new nn,Xe.swordSwing=new nn().setFromEuler(new Vn(-.6,0,.4)),Xe.sword=n.group,Xe.foreR&&Xe.foreR.add(n.group),Xe.bladeMat=n.bladeMat,_t.remove(Uc),Uc=null,_t.add(t),Bi=t,Xs&&(t.visible=!1),Er=!0,window.__alonRig=t},void 0,e=>console.warn("alon rig GLB failed — procedural ALON stays",e))}const Qa=new ce(new so(.5,20),new At({color:0,transparent:!0,opacity:.4}));Qa.rotation.x=-Math.PI/2;Qa.position.y=.04;Dn.add(Qa);oe.add(Dn);const zi=new ce(new ca(1.1,3.9,26,1,Math.PI*.6,Math.PI*.8),new At({color:3800968,transparent:!0,opacity:0,side:on,blending:Tn,depthWrite:!1}));{const i=document.createElement("canvas");i.width=i.height=128;const e=i.getContext("2d");if(e.createConicGradient){const t=e.createConicGradient(Math.PI*.4,64,64);t.addColorStop(0,"rgba(57,255,136,0)"),t.addColorStop(.7,"rgba(57,255,136,0.2)"),t.addColorStop(.96,"rgba(200,255,220,1)"),t.addColorStop(1,"rgba(57,255,136,0)"),e.fillStyle=t,e.fillRect(0,0,128,128);const n=new Dt(i);n.colorSpace=bt,zi.material.map=n,zi.material.color.set(16777215)}}zi.rotation.x=-Math.PI/2;zi.position.y=1.1;Dn.add(zi);const ks=Sm();ks.visible=!1;Dn.add(ks);let Kt=OS();Kt.visible=!1;oe.add(Kt);let ci=Kt.userData.parts,Ha=null;const te={active:!1,warnT:0,timer:40,pos:new R,dir:new R,runT:0,stompT:0,quake:!1,quakeDone:!1,quakeR:0,qx:0,qz:0},Ui=new ce(new ca(.92,1,64),new At({color:8257456,transparent:!0,opacity:0,depthWrite:!1,blending:Tn,side:on}));Ui.rotation.x=-Math.PI/2;Ui.visible=!1;oe.add(Ui);const Wu=new Pu;Wu.setMeshoptDecoder(Lu);Wu.load(yS,i=>{const e=i.scene;e.scale.setScalar(7),e.traverse(n=>{if(!n.isMesh)return;n.castShadow=!0,n.frustumCulled=!1;const s=n.material;s&&(s.name==="Horns"||s.name&&s.name.indexOf("Eye")===0?s.visible=!1:s.color&&(s.color.setRGB(.11,.075,.045),s.metalness=.45,s.roughness=.5,s.emissive=new pe(854021),s.emissiveIntensity=1))});const t=e.getObjectByName("Head");if(t){let l=function(x,v,M,C,_,S){const E=new Oe;E.position.set(x,v,M),E.rotation.x=_,E.rotation.z=S,wt(.032,.016,C,o,0,-C/2,0,E,8).scale.set(1,1,.82),ye(.04,o,0,-C*.34,0,E,1,.72,.9),ye(.034,o,0,-C*.68,0,E,1,.72,.9),ye(.032,c,0,-C-.01,0,E,1.2,.55,1.2),n.add(E)};const n=new Oe;n.name="ansemFace";const s=new Qe({color:6242090,roughness:.62,metalness:.05,emissive:2627856,emissiveIntensity:1});ye(.16,s,0,0,.1,n,.78,1.42,.72,24),ye(.07,s,-.098,.03,.13,n,.9,.85,.7),ye(.07,s,.098,.03,.13,n,.9,.85,.7),ye(.075,s,0,-.16,.13,n,.72,.95,.82);const r=new Oe;r.name="snoopEyes",n.add(r);for(const x of[-.062,.062])ye(.024,new Qe({color:13616822,roughness:.5,emissive:3946544,emissiveIntensity:1}),x,.055,.19,r,1.2,.5,.4),ye(.012,Ee(1314312,.35),x,.05,.205,r,1,.9,.8),ye(.03,s,x,.088,.185,r,1.3,.7,.7),ye(.026,Ee(1708560,.9),x,.11,.175,r,1.5,.4,.5);ye(.032,s,0,0,.23,n,.78,1.4,.82),ye(.036,s,0,-.05,.235,n,.85,.8,.85),ye(.008,Ee(1182728,.6),-.016,-.075,.245,n),ye(.008,Ee(1182728,.6),.016,-.075,.245,n);const a=new Qe({color:1774349,roughness:.95,emissive:985606,emissiveIntensity:1});ye(.026,a,0,-.1,.225,n,2,.22,.5),ye(.016,Ee(2365203,.6),0,-.13,.22,n,1.4,.26,.4);for(const x of[-1,1]){const v=wt(.012,.017,.19,a,x*.07,-.13,.16,n,6);v.rotation.z=x*.55,v.rotation.x=-.2,v.scale.z=.6}ye(.032,a,0,-.2,.16,n,.55,1.2,.6);const o=new Qe({color:2760467,roughness:.85,emissive:1840139,emissiveIntensity:1}),c=new Qe({color:13935921,roughness:.25,metalness:.8,emissive:4863759,emissiveIntensity:1});for(let x=0;x<7;x++){const v=(x-3)*.045,M=wt(.018,.024,.34,o,v,.18,.02,n,8);M.rotation.x=Math.PI/2-.08,M.scale.set(1,1,.6),M.position.y=.2-Math.abs(v)*.35}l(-.16,.16,.16,.5,-.5,.34),l(.16,.16,.16,.5,-.5,-.34),l(-.2,.13,.1,.58,-.4,.5),l(.2,.13,.1,.58,-.4,-.5),l(-.19,.06,.14,.62,-.62,.42),l(.19,.06,.14,.62,-.62,-.42),l(-.11,.19,.14,.42,-.45,.18),l(.11,.19,.14,.42,-.45,-.18);const h=new Oe;h.name="snoopShades",h.visible=!1,n.add(h);const u=new Qe({color:394758,roughness:.15,metalness:.6,emissive:1052692,emissiveIntensity:1});for(const x of[-.066,.066]){const v=ye(.05,u,x,.058,.205,h,1.2,.66,.42,16);v.rotation.y=x<0?.15:-.15}const d=wt(.01,.01,.06,u,0,.062,.225,h,6);d.rotation.z=Math.PI/2;const f=new Qe({color:11049600,roughness:.5,emissive:3813407,emissiveIntensity:1}),g=new Qe({color:13286816,roughness:.4,emissive:4865320,emissiveIntensity:1});for(const x of[-1,1]){const v=new Oe;v.position.set(x*.13,.16,.04),v.rotation.z=-x*.95,v.rotation.x=-.15,wt(.055,.03,.22,f,0,.11,0,v,10);const M=new ce(new xs(.03,.2,10),g);M.position.set(0,.27,.01),M.rotation.z=x*.55,v.add(M),n.add(v)}e.updateMatrixWorld(!0);const b=new R,m=new nn;t.getWorldScale(b),t.getWorldQuaternion(m);const p=new Oe;p.quaternion.copy(m.invert()),p.scale.setScalar(16/b.y),t.add(p),n.position.set(0,-.07,.16),p.add(n)}Ha=new Py(e),LS(i,Ha,"Gallop"),oe.remove(Kt),Kt=e,Kt.visible=te.active,oe.add(Kt),ci=null,window.__bullOk=!0},void 0,i=>console.warn("bull GLB failed — procedural ansem stays",i));Wu.load(SS,i=>{const e=i.scene,t=new si().setFromObject(e),n=t.getSize(new R),s=t.getCenter(new R),r=new Oe;e.position.set(-s.x,-t.min.y,-s.z),r.add(e),r.scale.setScalar(1/n.y),e.traverse(a=>{a.isMesh&&(a.castShadow=!sn,a.receiveShadow=!0)}),ds={w:n.x/n.y,d:n.z/n.y},Hs=r,Uf(),window.__tableOk=!0},void 0,i=>{console.warn("table GLB failed — wooden fallback",i),Hs=jS(),Uf()});function ol(i){try{return parseInt(localStorage.getItem(i)||"0",10)||0}catch{return 0}}function Oc(i,e){try{localStorage.setItem(i,String(e))}catch{}}let Za=ol("alonPump3dGold"),Jo=ol("alonPump3dXP"),ki=Math.max(1,ol("alonPump3dLvl")),Qo=ol("alonHordeBest");function Fc(i,e){const t=document.createElement("div");t.className="popup",t.textContent=i,e&&(t.style.color=e),sa.appendChild(t),setTimeout(()=>t.remove(),950)}const $h=document.getElementById("banner");let fc=0;function Hn(i){$h.textContent=i,$h.style.opacity=1,fc=2.2}const Ar={round:document.getElementById("round"),gold:document.getElementById("gold"),lvl:document.getElementById("lvl"),kills:document.getElementById("kills"),hpfill:document.getElementById("hpfill")},Bn={};function La(){Bn.round!==tn&&(Ar.round.textContent=Bn.round=tn),Bn.gold!==Za&&(Ar.gold.textContent=Bn.gold=Za),Bn.lvl!==ki&&(Ar.lvl.textContent=Bn.lvl=ki),Bn.kills!==Js&&(Ar.kills.textContent=Bn.kills=Js);const i=Math.max(0,Di);if(Bn.hp!==i){Bn.hp=i,Ar.hpfill.style.width=i+"%";const e=i>35?"#4ade80":"#f87171";Bn.hpbg!==e&&(Ar.hpfill.style.background=e,Bn.hpbg=e)}}function Ga(i){Za+=i,Oc("alonPump3dGold",Za)}function zm(i){Jo+=i;const e=ki*50;Jo>=e&&(Jo-=e,ki++,Oc("alonPump3dLvl",ki),Fc("⚡ LEVEL UP! "+ki,"#a78bfa")),Oc("alonPump3dXP",Jo)}let Wt="title",q=new R(0,0,0),yt=0,et=0;const nh=9.5,Wf=9.5,c1=22,l1=16;let Pe=0,it=0,ut=!0,Rr=0,Jn=0,Xf=0,is=0,Cr=0,Lt=0,Ia=0,mt=null,Zo=0,fa=!1,fn=0,$a=1,Xu=!1;function km(){Lt=15,Hn("🛹 SHRED MODE"),window.sRound()}let Di=100,ss=0,Pr=0,tn=1,Js=0,Da=0,Va=0,ih=0,eo=0,Or=0,Bc=0,dt=0,Rt=0,ct=[],jr=[],Hi=[];new R;const to={diamond:{label:"💎 DIAMOND HANDS",dur:8,color:7336703},lev:{label:"⚡ 10X LEVERAGE",dur:10,color:16766814},halt:{label:"🛑 TRADING HALTED",dur:4,color:16738922},moon:{label:"🚀 MOON BOOTS",dur:8,color:12159999},nuke:{label:"💥 LIQUIDATION EVENT",dur:0,color:9306032},board:{label:"🛹 SHRED MODE",dur:0,color:6750156}};let In=null,xn=0;const Hm=document.getElementById("power");let jf="";const fi=new ce(new Ys(1.1,.05,8,36),new At({color:7336703,transparent:!0,opacity:.7,blending:Tn,depthWrite:!1}));fi.rotation.x=Math.PI/2;fi.position.y=1.2;fi.visible=!1;Dn.add(fi);function h1(i){const e=to[i];if(Hn(e.label),window.sRound(),i==="board"){km();return}if(i==="nuke"){jt=Math.max(jt,.35),dt=1,window.sThunder(.05);for(let t=ct.length-1;t>=0;t--){const n=ct[t],s=n.mesh.position.x-q.x,r=n.mesh.position.z-q.z,a=Math.hypot(s,r)||1;rs(t,s/a,r/a,!0)}return}In=i,xn=e.dur}function u1(i){return 8+i*5}function Gm(){Va=u1(tn),Hn("ROUND "+tn),window.sRound()}const d1=new so(1,24),f1=new At({color:267275,transparent:!0,opacity:.85,depthWrite:!1});function p1(){const i=IS(),e=Math.random()*Math.PI*2,t=34+Math.random()*18;i.position.set(q.x+Math.cos(e)*t,0,q.z+Math.sin(e)*t),pc(i.position,wn-3);const n=tn>=4&&Math.random()<.16,s=!n&&tn>=2&&Math.random()<.14+tn*.012;i.scale.setScalar(n?1.3:.92+Math.random()*.14);const r=new ce(d1,f1.clone());r.rotation.x=-Math.PI/2,r.scale.setScalar(i.scale.x*1.15),r.position.set(i.position.x,Ii(i.position.x,i.position.z,0)+.05,i.position.z),oe.add(r);const a={mesh:i,pool:r,rise:.7,sp:(n?1.9:s?5.2+tn*.2:2.7+tn*.17)*(.85+Math.random()*.3),hp:n?4:1,dmg:n?18:9,bob:Math.random()*6.28,ph:Math.random()*6.28,pv:{legL:i.getObjectByName("legL"),legR:i.getObjectByName("legR"),shinL:i.getObjectByName("shinL"),shinR:i.getObjectByName("shinR"),armL:i.getObjectByName("armL"),armR:i.getObjectByName("armR"),foreL:i.getObjectByName("foreL"),foreR:i.getObjectByName("foreR"),head:i.getObjectByName("head")},leaves:dm(i)};ct.push(a)}function ju(i){i.pool&&(oe.remove(i.pool),i.pool.material.dispose(),i.pool=null)}function pc(i,e){i.z<-170&&Math.abs(i.x)<64&&(e=Math.max(e,350));const t=Math.hypot(i.x,i.z);t>e&&(i.x*=e/t,i.z*=e/t)}function m1(){const i=new ce(new Wn(.4,.4,.12,22),new Qe({color:16106776,emissive:16106776,emissiveIntensity:.5,roughness:.3,metalness:.6}));return i.rotation.x=Math.PI/2,i}function g1(){const i=new Oe,e=new Qe({color:4906624,emissive:4906624,emissiveIntensity:.5,roughness:.3}),t=new Qe({color:15790320,roughness:.3}),n=new ce(new Ka(.3,0,6,16),e);n.position.y=.28;const s=new ce(new Ka(.3,0,6,16),t);s.position.y=-.28;const r=new ce(new Wn(.3,.3,.56,16),e);return i.add(n),i.add(r),i.add(s),i.rotation.z=.8,i}function b1(i){const e=to[i].color;return new ce(new Au(.42,0),new Qe({color:e,emissive:e,emissiveIntensity:.75,roughness:.3,metalness:.2}))}const sh={};function x1(i){if(!sh[i]){const t=to[i].label.split(" ")[0],n=document.createElement("canvas");n.width=n.height=64;const s=n.getContext("2d");s.font="48px serif",s.textAlign="center",s.textBaseline="middle",s.fillText(t,32,36);const r=new Dt(n);r.colorSpace=bt,sh[i]=r}const e=new ji(new gi({map:sh[i],transparent:!0,depthWrite:!1,fog:!1}));return e.scale.set(.9,.9,.9),e}function v1(i,e){const t=Math.random();if(t<.44){const n=m1();n.position.set(i,1,e),oe.add(n),Hi.push({mesh:n,kind:"coin",t:16})}else if(t<.6){const n=g1();n.position.set(i,1,e),oe.add(n),Hi.push({mesh:n,kind:"pill",t:16})}else if(t<.72){const n=Math.random()<.06?"nuke":["diamond","lev","halt","moon","board"][Math.floor(Math.random()*5)],s=b1(n);s.position.set(i,1.1,e),oe.add(s);const r=x1(n);r.position.set(i,1.95,e),oe.add(r),Hi.push({mesh:s,kind:"power",pk:n,t:14,emoji:r})}}const _1=`
    varying vec3 vLocal;
    ...
    }`;function y1(){return new Vt({uniforms:{uD:{value:0},uBody:{value:new pe(921619)},uEdge:{value:new pe(7143344)}},vertexShader:_1,fragmentShader:M1,fog:!1})}function rs(i,e,t,n){const s=ct[i];ct.splice(i,1),ju(s),Js++;const r=s.mesh;oe.add(r);const a=y1();r.traverse(o=>{o.isMesh&&(o.material=a,o.castShadow=!1)}),r.userData={vy:7+Math.random()*(n?8:3),vx:e*(n?18:9),vz:t*(n?18:9),vr:(Math.random()-.5)*9,t:.7,fm:a,baseS:r.scale.x},jr.push(r),Ga((2+Math.floor(ki/2))*(In==="lev"&&xn>0?2:1)),zm(6),v1(r.position.x,r.position.z),Mn(r.position.x,1.4,r.position.z,10354628,12,7),window.sHit(),n||(Bc=.045,dt=Math.max(dt,.28),jt=Math.max(jt,.1))}function zc(){if(Wt!=="playing"||eo>0)return;const i=In==="lev"&&xn>0;eo=Math.max(.14,.24-ki*.008)*(i?.7:1),Or=.16,window.sSwipe();const e=-Math.sin(yt),t=-Math.cos(yt),n=i?5.4:4,s=i?-.5:-.15;for(let r=ct.length-1;r>=0;r--){const a=ct[r],o=a.mesh.position.x-q.x,c=a.mesh.position.z-q.z,l=Math.hypot(o,c);l<n&&(o*e+c*t)/(l||1)>s&&(a.hp--,a.hp<=0?rs(r,o/l,c/l,!1):(a.mesh.position.x+=o/l*2.4,a.mesh.position.z+=c/l*2.4,Mn(a.mesh.position.x,1.4,a.mesh.position.z,10354628,7,5),window.sHit()))}}function bi(){window.initAudio(),window.playMusic("play"),Jh=!1,ct.forEach(i=>{oe.remove(i.mesh),ju(i)}),ct=[],US(),jr.forEach(i=>{oe.remove(i),i.userData.fm&&i.userData.fm.dispose()}),jr=[],Hi.forEach(i=>{oe.remove(i.mesh),i.emoji&&oe.remove(i.emoji)}),Hi=[],Wt="playing",q.set(0,0,0),yt=0,et=0,Pe=Ii(0,0,0),it=0,ut=!0,Rr=0,Jn=0,is=Pe,Cr=0,Lt=0,Ia=0,aa.visible=!0,ks.visible=!1,mt=null,fn=0,$a=1,fa=!1;for(const i of Nn)i.surf&&(i.surfCd=0);window.setRoll(0),Di=100,ss=0,Pr=0,tn=1,Js=0,Da=0,eo=0,Or=0,Bc=0,te.active=!1,te.warnT=0,te.timer=42,te.quake=!1,te.quakeDone=!1,Ui.visible=!1,Kt.visible=!1,In=null,xn=0,Hm.textContent="",fi.visible=!1,pi=0,Xs=!1,Fr=0,_t.scale.setScalar(1),bn=0,yn&&(yn.visible=!1),Bi&&(Bi.visible=!0),Gt&&(js=0,Gt.visible=bs.visible=Ws.visible=!0,Br=.6);for(const i of Qs)i.cd=0,i.mesh.visible=i.halo.visible=!0;setTimeout(()=>{Wt==="playing"&&Hn("🫧 GRAB A FLOATING CUPSEY TO FLY")},4e3),jt=0,Bs.uniforms.uHurt.value=0,Gm(),La(),document.getElementById("startScreen").style.display="none",document.getElementById("gameOver").style.display="none",sn&&(document.getElementById("joyZone").style.display="block",document.getElementById("btnAttack").style.display="flex",document.getElementById("btnJump").style.display="flex")}document.getElementById("startBtn").addEventListener("click",bi);document.getElementById("restartBtn").addEventListener("click",i=>{i.stopPropagation(),vs()&&bi()});window.__engineUp=!0;{const i=document.getElementById("startBtn");i.disabled=!1;const e=document.getElementById("loadNote");e&&(e.style.color="#4b6355",e.textContent="ready — press SURVIVE")}let Vm=0;const vs=()=>Wt==="dead"&&performance.now()-Vm>800;function S1(){window.sDeath(),window.setRoll(0),mt=null,dt=1,Wt="dead",window.playMusic("dead"),Vm=performance.now();const i=tn>Qo;i&&(Qo=tn,Oc("alonHordeBest",Qo)),setTimeout(()=>{if(Wt!=="dead")return;document.getElementById("finalRound").textContent=tn,document.getElementById("finalKills").textContent=Js,document.getElementById("bestRound").textContent=Qo,document.getElementById("finalGold").textContent=Za;const e=document.getElementById("goHead");i?(e.textContent="🏆 NEW BEST",e.style.color="#ffd75e",window.sRound()):(e.textContent="OVERRUN",e.style.color="#f87171"),document.getElementById("shareBtn").onclick=()=>{const t=`survived ${tn} rounds vs the jeet horde (${Js} kills) in PUMP CASTLE 🏰⚔️ $ALON`+(i?" — NEW BEST":"");window.open("https://twitter.com/intent/tweet?text="+encodeURIComponent(t)+"&url="+encodeURIComponent("https://alonpump.run/castle.html"),"_blank")},document.getElementById("gameOver").style.display="flex"},600)}document.getElementById("gameOver").addEventListener("click",()=>{vs()&&bi()});let qf=!1;function w1(){qf||(qf=!0,window.initAudio(),Wt==="title"&&window.playMusic("menu"))}["pointerdown","touchstart","keydown"].forEach(i=>window.addEventListener(i,w1,{passive:!0}));const dn={};let qu=0,Yu=0,_n=0,cs=0,Os=0;sa.addEventListener("wheel",i=>{i.preventDefault(),_n-=i.deltaX*.01,Os=Math.max(-.5,Math.min(1.35,Os+i.deltaY*.004)),cs=1.5},{passive:!1});addEventListener("keydown",i=>{const e=i.key.toLowerCase();["arrowleft","arrowright","arrowup","arrowdown"," ","a","d","w","s","x","f","q","e"].includes(e)&&i.preventDefault(),dn[e]=!0,!i.repeat&&(e==="m"&&window.toggleMute(),e===" "&&(Wt==="dead"?vs()&&bi():Lt>0&&ut?(fa=!0,fn=.001):Jn=.12),(e==="x"||e==="f")&&(Wt==="dead"?vs()&&bi():zc()))});addEventListener("keyup",i=>{dn[i.key.toLowerCase()]=!1,i.key===" "&&(fa=!1,fn>0?($a=1+Math.min(.5,fn),fn=0,Jn=.12):it>3.5&&Lt<=0&&(it=3.5))});location.search.includes("autodemo")&&setTimeout(()=>{bi(),dn.w=!0,setTimeout(()=>{dn.w=!1,dn.a=!0},2500)},1300);let Ku=!1,eu=0;It.domElement.addEventListener("mousedown",i=>{if(Wt==="dead"){vs()&&bi();return}Wt==="playing"&&zc(),Ku=!0,eu=i.clientX});addEventListener("mousemove",i=>{Ku&&(_n-=(i.clientX-eu)*.008,eu=i.clientX,cs=1.5)});addEventListener("mouseup",()=>{Ku=!1});const cl=document.getElementById("joyZone"),kc=document.getElementById("joyKnob");let ll=null;const Yf=70,Ta=44,Kf=7;function A1(){kc.style.left="45px",kc.style.top="45px",qu=0,Yu=0,ll=null}function Wm(i){const e=cl.getBoundingClientRect();let t=i.clientX-e.left-Yf,n=i.clientY-e.top-Yf;const s=Math.hypot(t,n);s>Ta&&(t=t/s*Ta,n=n/s*Ta),kc.style.left=45+t+"px",kc.style.top=45+n+"px",qu=Math.abs(t)>Kf?t/Ta:0,Yu=Math.abs(n)>Kf?n/Ta:0}cl.addEventListener("touchstart",i=>{i.preventDefault();const e=i.changedTouches[0];ll=e.identifier,Wm(e)},{passive:!1});cl.addEventListener("touchmove",i=>{i.preventDefault();for(const e of i.changedTouches)e.identifier===ll&&Wm(e)},{passive:!1});cl.addEventListener("touchend",i=>{for(const e of i.changedTouches)e.identifier===ll&&A1()},{passive:!1});const Gs=document.getElementById("btnAttack");Gs.addEventListener("touchstart",i=>{if(i.preventDefault(),Wt==="dead"){vs()&&bi();return}zc(),clearInterval(Gs._hold),Gs._hold=setInterval(()=>{Wt==="playing"&&zc()},120)},{passive:!1});Gs.addEventListener("touchend",i=>{clearInterval(Gs._hold)},{passive:!1});Gs.addEventListener("touchcancel",i=>{clearInterval(Gs._hold)},{passive:!1});const Xm=document.getElementById("btnJump");Xm.addEventListener("touchstart",i=>{if(i.preventDefault(),Wt==="dead"){vs()&&bi();return}Xu=!0,Lt>0&&ut?(fa=!0,fn=.001):Jn=.15},{passive:!1});Xm.addEventListener("touchend",i=>{fa=!1,Xu=!1,fn>0?($a=1+Math.min(.5,fn),fn=0,Jn=.12):it>3.5&&Lt<=0&&(it=3.5)},{passive:!1});let Hc=null,tu=0;It.domElement.addEventListener("touchstart",i=>{if(i.preventDefault(),Wt==="dead"){vs()&&bi();return}const e=i.changedTouches[0];Hc=e.identifier,tu=e.clientX},{passive:!1});It.domElement.addEventListener("touchmove",i=>{i.preventDefault();for(const e of i.changedTouches)e.identifier===Hc&&(_n-=(e.clientX-tu)*.008,tu=e.clientX,cs=1.5)},{passive:!1});It.domElement.addEventListener("touchend",i=>{for(const e of i.changedTouches)e.identifier===Hc&&(Hc=null)},{passive:!1});window.__dbg=()=>JSON.stringify({f:Rt,st:Wt,j:ct.length,q:Va,k:Js,an:te.active,hp:Di,py:+Pe.toFixed(2),bd:+Lt.toFixed(1),gr:ut,sf:!!mt,tn:window.__tablesN||0,h:+yt.toFixed(2),cy:+_n.toFixed(2),calls:It.info.render.calls,tris:It.info.render.triangles,ic:Wr[0]?Wr[0].count:-1,nparts:Wr.length});window.__measureScene=()=>(It.render(oe,Nt),{calls:It.info.render.calls,tris:It.info.render.triangles,objs:oe.children.length});const T1=new $p,jm=30,E1=.9,gs=12,di={x:0,z:-50},qm=32,R1=5,Ym=.36,rh=1.5,Jf=4,Km=2.9;let Vs=null,yn=null,zn=null,Gt=null,Ws=null,bs=null,Qs=[],pi=0,Xs=!1,Fr=0,Jm=0,nu=!1,ah=0,js=0,Br=0,Lr=0,bn=0;const C1=Xr.uniforms.top.value.clone(),P1=new pe(4163268),L1=Xr.uniforms.bot.value.clone(),I1=new pe(13495029),D1=oe.fog.color.clone(),N1=new pe(10931423),U1=new pe(16054783),O1=Jt.color.clone(),F1=new pe(16773846);function B1(i){return{armL:i.getObjectByName("ArmL"),armR:i.getObjectByName("ArmR"),footL:i.getObjectByName("FootL"),footR:i.getObjectByName("FootR")}}{const i=new Pu;i.setMeshoptDecoder(Lu),i.load(wS,e=>{Vs=e.scene,Vs.traverse(t=>{t.isMesh&&(t.frustumCulled=!1,t.castShadow=!0)}),yn=Vs.clone(!0),yn.scale.setScalar(E1),yn.rotation.y=Math.PI,yn.visible=!1,_t.add(yn),zn=B1(yn),z1()},void 0,e=>console.warn("cupsey GLB failed",e))}let Ea=null;function Qm(){if(Ea)return Ea;const i=document.createElement("canvas");i.width=i.height=128;const e=i.getContext("2d"),t=e.createRadialGradient(64,64,4,64,64,64);return t.addColorStop(0,"rgba(150,255,190,0.85)"),t.addColorStop(1,"rgba(150,255,190,0)"),e.fillStyle=t,e.fillRect(0,0,128,128),Ea=new Dt(i),Ea.colorSpace=bt,Ea}function z1(){if(!Vs||Gt)return;Gt=Vs.clone(!0),Gt.scale.setScalar(gs),Gt.rotation.y=Math.PI,Gt.traverse(n=>{n.isMesh&&(n.frustumCulled=!1,n.material=n.material.clone(),n.material.emissive=new pe(2902558),n.material.emissiveIntensity=.45)}),Gt.position.set(di.x,qm,di.z),oe.add(Gt),bs=new ji(new gi({map:Qm(),transparent:!0,fog:!1,depthWrite:!1,blending:Tn,opacity:.6})),bs.scale.set(gs*3.4,gs*3.4,1),oe.add(bs);const i=document.createElement("canvas");i.width=256,i.height=64;const e=i.getContext("2d");e.font="44px serif",e.textAlign="center",e.textBaseline="middle",e.fillText("🫧 CUPSEY",128,36);const t=new Dt(i);t.colorSpace=bt,Ws=new ji(new gi({map:t,transparent:!0,fog:!1,depthWrite:!1})),Ws.scale.set(24,6,1),oe.add(Ws),Br=.6,H1()}function k1(i,e){const t=Vs.clone(!0);t.scale.setScalar(rh),t.traverse(s=>{s.isMesh&&(s.frustumCulled=!1,s.material=s.material.clone(),s.material.emissive=new pe(2902558),s.material.emissiveIntensity=.55)}),t.position.set(i,Km,e),oe.add(t);const n=new ji(new gi({map:Qm(),transparent:!0,fog:!1,depthWrite:!1,blending:Tn,opacity:.7}));return n.scale.set(rh*4,rh*4,1),oe.add(n),{mesh:t,halo:n,x:i,z:e,ph:Math.random()*6.28,cd:0}}function H1(){if(!(!Vs||Qs.length))for(let i=0;i<Jf;i++){const e=i/Jf*Math.PI*2+Math.random()*.6,t=40+Math.random()*(wn-90);Qs.push(k1(Math.cos(e)*t,Math.sin(e)*t))}}function G1(i){for(const e of Qs){if(e.cd>0){e.cd-=i,e.cd<=0&&(e.mesh.visible=e.halo.visible=!0);continue}e.ph+=i;const t=Km+Math.sin(e.ph*1.6)*.4;e.mesh.position.set(e.x,t,e.z),e.mesh.rotation.y+=i*1.2,e.halo.position.set(e.x,t,e.z),e.halo.material.opacity=.55+Math.sin(e.ph*3)*.2}}function V1(){if(!Xs){for(const i of Qs)if(!(i.cd>0)&&Math.hypot(q.x-i.x,q.z-i.z)<2.3&&Math.abs(Pe-i.mesh.position.y)<2.6){i.mesh.visible=i.halo.visible=!1,i.cd=18,Mn(i.x,i.mesh.position.y,i.z,9371568,18,6),window.sRound&&window.sRound(),Zm();return}}}function W1(i){if(!Gt)return;if(js>0){js-=i,js<=0&&(Gt.visible=bs.visible=Ws.visible=!0,Br=.6);return}ah+=i;const e=qm+Math.sin(ah*.5)*R1;Gt.position.set(di.x,e,di.z),Gt.rotation.y+=i*.2;let t=gs;Br>0&&(Br-=i,t*=1-Math.max(0,Br/.6)*.85),Gt.scale.setScalar(t);const n=e+gs*1.35;bs.position.set(di.x,n,di.z),bs.material.opacity=.45+Math.sin(ah*2)*.15,Ws.position.set(di.x,e+gs*2.9,di.z)}function X1(){if(!Gt||js>0)return;const i=Gt.position.y,e=di.x,t=di.z,n=i+gs*1.15,s=gs*1.25,r=q.x-e,a=Pe+1.3-n,o=q.z-t;r*r+a*a+o*o<s*s&&(Ga(5e3),zm(40),Fc("+5000  🫧 GIANT CUPSEY!","#8effb0"),Hn("🫧 GIANT CUPSEY BLAST  +5000"),Kn(e,n,t,{n:90,color:9371568,sp:26,up:16,grav:9,life:1.4,size:1.2,spread:16}),Kn(e,n,t,{n:60,color:15788758,sp:20,up:12,grav:9,life:1.3,size:1.1,spread:13}),Mn(e,n,t,16777215,40,12),dt=Math.max(dt,.9),jt=Math.max(jt,.5),window.sThunder&&window.sThunder(.05),Gt.visible=bs.visible=Ws.visible=!1,js=55,pi=jm)}function Zm(){pi=jm,Lr=0,it=Math.max(it,3),ut=!1,$m(1),Hn("🫧 CUPSEY FLIGHT — FLY!")}function j1(){pi=0,$m(-1),ut=!1,it=Math.min(it,0),Hn("CUPSEY FADES…")}function $m(i){Jm=i,Fr=Ym,nu=!1,Kn(q.x,Pe+1.2,q.z,{n:34,color:i>0?9371568:16769184,sp:13,up:10,grav:7,life:.9,size:.55,spread:7}),Mn(q.x,Pe+1.4,q.z,16777215,22,8),dt=Math.max(dt,.5),jt=Math.max(jt,.3),window.sRound&&window.sRound()}function q1(i){if(Fr<=0){_t.scale.setScalar(1);return}Fr-=i;const e=1-Math.max(0,Fr)/Ym;_t.scale.setScalar(1-Math.sin(Math.min(1,e)*Math.PI)*.82),!nu&&e>=.5&&(nu=!0,Jm>0?(Bi&&(Bi.visible=!1),yn&&(yn.visible=!0)):(yn&&(yn.visible=!1),Bi&&(Bi.visible=!0))),Fr<=0&&_t.scale.setScalar(1)}function Y1(i){Lr+=i;const e=Math.sin(Lr*9)*.7;zn&&(zn.armL&&(zn.armL.rotation.z=.5+e,zn.armL.rotation.x=.2),zn.armR&&(zn.armR.rotation.z=-.5-e,zn.armR.rotation.x=.2),zn.footL&&(zn.footL.rotation.x=-.5+Math.sin(Lr*3)*.15),zn.footR&&(zn.footR.rotation.x=-.5-Math.sin(Lr*3)*.15)),_t.position.y=.1+Math.sin(Lr*2.4)*.18;const t=Math.min(1,et/5);_t.rotation.x=t*.35,_t.rotation.z=0,_t.rotation.y=0}window.__cupsey=()=>Zm();window.__cupBoosters=()=>Qs.map(i=>({x:+i.x.toFixed(0),z:+i.z.toFixed(0),cd:+i.cd.toFixed(1),vis:i.mesh.visible}));window.__gotoBooster=()=>{const i=Qs.find(e=>e.cd<=0);return i&&(q.x=i.x,q.z=i.z,Pe=i.mesh.position.y),!!i};window.__giant=()=>Gt&&{y:+Gt.position.y.toFixed(1),cd:+js.toFixed(1),vis:Gt.visible};window.__cupState=()=>({cupseyT:+pi.toFixed(1),dayT:+bn.toFixed(2),active:Xs,rigVis:!!(yn&&yn.visible),alonVis:!!(Bi&&Bi.visible)});function e0(i){const e=i;if(Rt++,Bc>0&&(Bc-=e,i=0),fc>0&&(fc-=e,fc<=0&&($h.style.opacity=0)),Pi&&Wt==="playing"&&!Jh&&Math.hypot(q.x-Pi.x,q.z-Pi.z)<Pi.r&&Pe>Pi.y-1.2&&(Jh=!0,Hn("🏰 YOU REACHED PUMP CASTLE  +500 🪙"),Ga(500),Kn(Pi.x,Pi.y+1,Pi.z,{n:44,color:7143344,sp:13,up:11,grav:6,life:1.3,size:.5,spread:9})),Wt==="playing"){Xs=pi>0;const a=Xs;W1(i),G1(i),q1(i),a?(pi-=i,X1(),pi<=0&&j1()):V1(),dn.q&&(_n+=2.4*i,cs=1.5),dn.e&&(_n-=2.4*i,cs=1.5),cs>0?cs-=i:Os!==0&&(Os+=(0-Os)*Math.min(1,i*1.5));let o=qu+(dn.d||dn.arrowright?1:0)-(dn.a||dn.arrowleft?1:0),c=Yu+(dn.s||dn.arrowdown?1:0)-(dn.w||dn.arrowup?1:0);const l=Math.hypot(o,c);l>1&&(o/=l,c/=l);const h=Math.cos(_n),u=Math.sin(_n),d=o*h+c*u,f=-o*u+c*h,g=l>.01;if(a){const _=nh*1.6;if(et+=((g?_*Math.min(1,l):0)-et)*i*5,g){let y=((Math.atan2(-d,-f)-yt+Math.PI)%(Math.PI*2)+Math.PI*2)%(Math.PI*2)-Math.PI;yt+=y*Math.min(1,i*10),q.x+=d*et*i,q.z+=f*et*i,pc(q,wn-1.5)}const S=dn[" "]||Xu;it+=((S?12:-3.5)-it)*Math.min(1,i*3.5),Pe+=it*i;const E=Ii(q.x,q.z,Pe)+1.6;Pe<E&&(Pe=E,it<0&&(it=0)),Pe>42&&(Pe=42,it>0&&(it=0)),ut=!1,ss=Math.max(ss,.12),is+=(Pe-is)*Math.min(1,i*3);for(let w=ct.length-1;w>=0;w--){const y=ct[w],P=y.mesh.position.x-q.x,N=y.mesh.position.z-q.z;if(P*P+N*N<9&&Pe-y.mesh.position.y<4){const D=Math.hypot(P,N)||1;rs(w,P/D,N/D,!0)}}}else if(mt){mt.t-=i;const _=mt.o,S=o*.9*i,E=mt.dx*Math.cos(S)-mt.dz*Math.sin(S);mt.dz=mt.dx*Math.sin(S)+mt.dz*Math.cos(S),mt.dx=E,_.x+=mt.dx*22*i,_.z+=mt.dz*22*i,Math.hypot(_.x,_.z)>wn-4&&(mt.t=0);const w=gt(_.x,_.z);_.topY=w+_.baseH,_.mesh.position.set(_.x,w,_.z),q.x=_.x,q.z=_.z,yt=Math.atan2(-mt.dx,-mt.dz),et=22;for(let y=ct.length-1;y>=0;y--){const P=ct[y],N=P.mesh.position.x-_.x,D=P.mesh.position.z-_.z,B=Math.hypot(N,D)||1;B<Math.max(_.hw,_.hd)+1.3&&rs(y,N/B,D/B,!0)}Rt%4===0&&Kn(_.x-mt.dx*_.hw,w+.3,_.z-mt.dz*_.hd,{n:2,color:3818040,sp:3,up:2,grav:5,life:.5,size:.4,spread:1.5,smoke:!0}),dt=Math.max(dt,.12),(!ut||mt.t<=0)&&(mt=null)}else if(Lt>0){Lt-=i;const _=o,S=-c;yt-=_*i*(1.5+Math.min(1.1,et*.07));const E=S>.1?l1*Math.min(1,S):S<-.1?2:et;et+=(E-et)*i*(S>.1?2.2:1.5),S<=.1&&S>=-.1&&(et*=1-.12*i);const w=-Math.sin(yt),y=-Math.cos(yt);Zo=(Ii(q.x+w*.9,q.z+y*.9,Pe)-Ii(q.x,q.z,Pe))/.9,ut&&(et-=Zo*9.5*i,S>.1&&Zo<-.15&&(et+=6*i)),et=Math.max(0,Math.min(24,et)),q.x+=-Math.sin(yt)*et*i,q.z+=-Math.cos(yt)*et*i,pc(q,wn-1.5),Lt<=0&&(Lt=0,et=Math.min(et,nh))}else{const _=nh*(In==="moon"&&xn>0?1.38:1);if(et+=((g?_*Math.min(1,l):0)-et)*i*6,g){let E=((Math.atan2(-d,-f)-yt+Math.PI)%(Math.PI*2)+Math.PI*2)%(Math.PI*2)-Math.PI;yt+=E*Math.min(1,i*12),q.x+=d*et*i,q.z+=f*et*i,pc(q,wn-1.5)}}if((g||Lt>0)&&cs<=0){let _=((yt-_n+Math.PI)%(Math.PI*2)+Math.PI*2)%(Math.PI*2)-Math.PI;_n+=_*Math.min(1,i*1.5)*Math.min(1,et/4)}for(const _ of Nn){const S=q.x-_.x,E=q.z-_.z;if(Math.abs(S)<_.hw+.45&&Math.abs(E)<_.hd+.45&&Pe<_.topY-.45&&Pe>(_.botY??-1e9)-.45)if(!ut&&Lt<=0&&it<3&&_.topY-Pe<1.5)Pe=_.topY,it=0,ut=!0,Cr=0,Kn(q.x,Pe+.1,q.z,{n:3,color:3818040,sp:1.5,up:1.2,grav:3,life:.4,size:.2,spread:.5,smoke:!0});else{const w=_.hw+.45-Math.abs(S),y=_.hd+.45-Math.abs(E);w<y?q.x=_.x+Math.sign(S||1)*(_.hw+.45):q.z=_.z+Math.sign(E||1)*(_.hd+.45)}}const b=Ii(q.x,q.z,Pe);if(!a){if(Jn>0&&(Jn-=i),Rr>0&&(Rr-=i),ut&&(Xf=i>0?(b-Pe)/i:0,Pe>b+.28?(ut=!1,Rr=.12,it=Math.max(0,Math.min(12,Xf))*.8):Pe=b),fn>0&&fa&&ut&&(fn=Math.min(.6,fn+i)),ut||(fn=0),(ut||Rr>0)&&Jn>0?(it=Wf*(Lt>0?.85*$a:1),$a=1,ut=!1,Rr=0,Jn=0,Cr=0,window.sJump()):!ut&&Jn>0&&Cr<1&&(it=Wf*.92,Cr++,Jn=0,window.sJump(),Mn(q.x,Pe+.3,q.z,8257448,8,3)),!ut){it-=c1*i;const _=Pe;Pe+=it*i;let S=b;if(it<0)for(const E of Nn){const w=E.pad||0;E.topY>S&&E.topY<=_+.05&&E.topY>=Pe&&Math.abs(q.x-E.x)<E.hw+w&&Math.abs(q.z-E.z)<E.hd+w&&(S=E.topY)}Pe<=S&&it<=0&&(Pe=S,it=0,ut=!0,Cr=0,Kn(q.x,Pe+.1,q.z,{n:3,color:3818040,sp:1.6,up:1,grav:3,life:.4,size:.22,spread:.6,smoke:!0}))}for(const _ of Kh)ut&&Math.hypot(q.x-_.x,q.z-_.z)<1.7&&Math.abs(Pe-_.y)<1.2&&(it=14,ut=!1,window.sVent(),Mn(_.x,_.y+.8,_.z,7339935,16,6))}Dn.position.set(q.x,Pe,q.z),Dn.rotation.y=yt,a||(ut?is=Pe:Pe<is-.6&&(is+=(Pe-is)*Math.min(1,i*8))),Qa.position.y=b-Pe+.04;const m=1/(1+Math.max(0,Pe-b)*.35);Qa.scale.setScalar(m),ss>0&&(ss-=i),Pr>0&&(Pr-=i),eo>0&&(eo-=i),Or>0&&(Or-=i);const p=Dn.userData.runT=(Dn.userData.runT||0)+et*i*2.1,x=Math.min(1,et/4),v=yt+Math.PI;if(a)Y1(i),ks.visible=!1;else if(ks.visible=Lt>0,Lt>0||mt){const _=o;_t.rotation.y=.55,_t.rotation.x=0,_t.rotation.z=-_*.28,ks.rotation.z=-_*.22,_t.position.y=.16-fn*.12,ks.rotation.x=ut?Math.max(-.5,Math.min(.5,Math.atan(-Zo)*.55)):it>0?-.35*Math.min(1,it/8):.28*Math.min(1,-it/8),Er&&(nt(Xe.legL,.3+fn*.9,0,.28),nt(Xe.legR,-.35-fn*.7,0,-.28),nt(Xe.shinL,0,0,0),nt(Xe.shinR,0,0,0),Ur(Xe.armL,v+.55,1,.85,.15),nt(Xe.foreL,.2,0,0),nt(Xe.spine,.14,-_*.18,_*.12),nt(Xe.head,-.06,_*.1,0)),ut&&et>6&&Rt%5===0&&Mn(q.x,Pe+.15,q.z,5898144,1,2)}else if(!ut)_t.rotation.y=0,_t.rotation.z=0,Er&&(nt(Xe.legL,-.7,0,0),nt(Xe.legR,.5,0,0),nt(Xe.shinL,.9,0,0),nt(Xe.shinR,0,0,0),Ur(Xe.armL,v,1,.18,.5),nt(Xe.foreL,.35,0,0),nt(Xe.spine,.22,0,0),nt(Xe.head,-.14,0,0)),_t.position.y=.05,_t.rotation.x=.08;else{_t.rotation.y=0,_t.rotation.z=0,Er&&(nt(Xe.legL,Math.sin(p)*1*x,0,0),nt(Xe.legR,Math.sin(p+Math.PI)*1*x,0,0),nt(Xe.shinL,Math.max(0,-Math.sin(p))*.8*x,0,0),nt(Xe.shinR,Math.max(0,-Math.sin(p+Math.PI))*.8*x,0,0),Ur(Xe.armL,v,1,.18,Math.sin(p+Math.PI)*.35*x),nt(Xe.foreL,.2,0,0),nt(Xe.spine,(.17+Math.abs(Math.sin(p))*.09)*x,Math.sin(p)*.22*x,Math.sin(p)*.07*x),nt(Xe.head,(-.12+Math.abs(Math.sin(p))*.06)*x,Math.sin(p)*-.13*x,0)),_t.position.y=.05+Math.abs(Math.sin(p))*.1*x,_t.rotation.x=x*.05;const _=Math.sin(p)>0;Dn.userData.stepUp!==_&&et>4&&(Dn.userData.stepUp=_,Kn(q.x+Math.sin(yt)*.6,Dn.position.y+.12,q.z+Math.cos(yt)*.6,{n:2,color:3818040,sp:1.4,up:1.1,grav:2.5,life:.5,size:.22,spread:.4,smoke:!0}))}if(!mt){for(const _ of Nn)if(_.surf){if(_.surfCd>0){_.surfCd-=i;continue}ut&&Math.abs(q.x-_.x)<_.hw&&Math.abs(q.z-_.z)<_.hd&&Math.abs(Pe-_.topY)<.4&&(mt={o:_,t:6,dx:-Math.sin(yt),dz:-Math.cos(yt)},_.surfCd=30,Hn("🏄 THE BLACK TABLE RIDES"),window.sHorn(),dt=Math.max(dt,.35))}}Ia>0?(Ia-=i,Ia<=0&&(aa.visible=!0)):Lt<=0&&Math.hypot(q.x-ra.x,q.z-ra.z)<2.2&&(km(),aa.visible=!1,Ia=35);for(const _ of Kh)_.ring.scale.setScalar(1+Math.sin(Rt*.09+_.ph)*.15),_.ring.material.opacity=.35+Math.sin(Rt*.13+_.ph)*.2;if(Or>0){const _=Math.sin((.16-Or)/.16*Math.PI);if(Er){const S=Math.sin(v),E=Math.cos(v);Zh(Xe.armR,S*.75,.55-_*1.4,E*.75),nt(Xe.foreR,-.3-_*.5,0,.2),Xe.sword.quaternion.copy(Xe.swordSwing)}zi.material.opacity=_*(zi.material.map?.85:.5),zi.rotation.z=-_*2.2,cc.intensity=_*5}else Er&&(Ur(Xe.armR,v,-1,.18,Math.sin(p)*.25*x),nt(Xe.foreR,.2,0,0),Zh(Xe.sword,Math.sin(v),-.2,Math.cos(v))),zi.material.opacity*=.8,cc.intensity*=.8;cc.position.set(q.x-Math.sin(yt)*1.5,1.6,q.z-Math.cos(yt)*1.5),xn>0&&(xn-=i,xn<=0&&(In=null));const M=[];mt&&M.push("🏄 TABLE "+Math.ceil(mt.t)+"s"),Lt>0&&M.push("🛹 SHRED "+Math.ceil(Lt)+"s"),In&&xn>0&&M.push(to[In].label+" "+Math.ceil(xn)+"s"),pi>0&&M.push("🫧 CUPSEY FLIGHT "+Math.ceil(pi)+"s");const C=M.join("  ·  ");C!==jf&&(Hm.textContent=C,jf=C),window.setRoll((Lt>0||mt)&&ut?Math.min(.15,.02+et*.006):0),Xe.bladeMat&&(Xe.bladeMat.emissiveIntensity=In==="lev"&&xn>0?1.7:.8),fi.visible=In==="diamond"&&xn>0,fi.visible&&(fi.rotation.z+=i*2.4,fi.scale.setScalar(1+Math.sin(Rt*.15)*.08),fi.material.opacity=.5+Math.sin(Rt*.2)*.2),In==="moon"&&xn>0&&et>4&&Rt%4===0&&Mn(q.x,.4,q.z,12159999,2,2),Va>0&&(ih-=i,ih<=0&&ct.length<46&&(ih=Math.max(.13,.5-tn*.028),Va--,p1()));for(let _=ct.length-1;_>=0;_--){const S=ct[_],E=S.mesh,w=q.x-E.position.x,y=q.z-E.position.z,P=Math.hypot(w,y)||1;if(E.rotation.y=Math.atan2(-w,-y),S.rise>0){S.rise-=i;const j=Math.max(0,S.rise/.7);E.position.y=Ii(E.position.x,E.position.z,0)-2.2*E.scale.y*j*j,S.pool&&(S.pool.material.opacity=.85*Math.min(1,.3+j)),S.rise<=0&&ju(S);continue}if(Lt>0&&P<1.7&&Math.abs(Pe-E.position.y)<1.8&&et>4.5){rs(_,-Math.sin(yt),-Math.cos(yt),!0);continue}if(In==="halt"&&xn>0)continue;const N=Math.sin(Rt*.03+S.ph)*.35;E.position.x+=(w/P+Math.cos(S.ph)*N*.2)*S.sp*i,E.position.z+=(y/P+Math.sin(S.ph)*N*.2)*S.sp*i;for(const j of Nn){if(E.position.y<(j.botY??-1e9)-.9)continue;const k=E.position.x-j.x,re=E.position.z-j.z;if(Math.abs(k)<j.hw+.4&&Math.abs(re)<j.hd+.4){const ue=j.hw+.4-Math.abs(k),fe=j.hd+.4-Math.abs(re);ue<fe?E.position.x=j.x+Math.sign(k||1)*(j.hw+.4):E.position.z=j.z+Math.sign(re||1)*(j.hd+.4)}}S.bob+=i*(3.4+S.sp*1.5),E.position.y=Ii(E.position.x,E.position.z,E.position.y)+Math.abs(Math.sin(S.bob))*.06;const D=S.pv,B=Math.sin(S.bob),W=Math.sin(S.bob+Math.PI),V=Math.min(1,S.sp/3);D.legL.rotation.x=B*.85*V,D.legR.rotation.x=W*.85*V,D.shinL.rotation.x=Math.max(0,W)*.9*V,D.shinR.rotation.x=Math.max(0,B)*.9*V,D.armL.rotation.x=-.55+W*.45*V,D.armR.rotation.x=-.55+B*.45*V,D.foreL.rotation.x=-.5+Math.max(0,B)*.3,D.foreR.rotation.x=-.5+Math.max(0,W)*.3,E.rotation.z=Math.sin(S.bob*.5+S.ph)*.05,D.head.rotation.x=-.08+Math.sin(S.bob*2)*.03,P<3&&(D.armL.rotation.x=-1.35+B*.2,D.armR.rotation.x=-1.6+W*.2,D.foreL.rotation.x=-.9,D.foreR.rotation.x=-.9),Math.random()<.07*i&&window.sGroan(Math.max(.04,.16-P*.004)),!(Lt>0)&&P<1.5&&ss<=0&&Pe-E.position.y<1.3&&(In==="diamond"&&xn>0?(ss=.4,Mn(q.x,1.4,q.z,7336703,10,5),window.sHit(),dt=Math.max(dt,.15),E.position.x-=w/P*3.2,E.position.z-=y/P*3.2):(Di-=S.dmg,ss=.55,Pr=.55,window.sHurt(),dt=Math.max(dt,.45),jt=Math.max(jt,.2),E.position.x-=w/P*2.2,E.position.z-=y/P*2.2,La(),Di<=0&&S1()))}for(let _=0;_<ct.length;_++){const S=ct[_];if(!(S.rise>0))for(let E=_+1;E<ct.length;E++){const w=ct[E];if(w.rise>0)continue;let y=w.mesh.position.x-S.mesh.position.x,P=w.mesh.position.z-S.mesh.position.z;const N=y*y+P*P;if(N<1.44&&N>1e-4){const D=Math.sqrt(N),B=(1.2-D)*3*i;y/=D,P/=D,S.mesh.position.x-=y*B,S.mesh.position.z-=P*B,w.mesh.position.x+=y*B,w.mesh.position.z+=P*B}}}if(Va===0&&ct.length===0)if(Da<=0){const _=12+tn*6;Ga(_),Hn("ROUND "+tn+" CLEARED  +"+_+" 🪙"),window.sRound(),Da=3}else Da-=i,Da<=0&&(tn++,Gm(),La());if(te.active){if(te.pos.x+=te.dir.x*26*i,te.pos.z+=te.dir.z*26*i,te.runT+=26*i*.32,ci?(ci.legFL.rotation.x=Math.sin(te.runT)*.8,ci.legFR.rotation.x=Math.sin(te.runT+.5)*.8,ci.legBL.rotation.x=Math.sin(te.runT+Math.PI)*.8,ci.legBR.rotation.x=Math.sin(te.runT+Math.PI+.5)*.8,ci.tail.rotation.x=.5+Math.sin(te.runT*.7)*.3,ci.head.rotation.x=.35):Ha&&(Ha.timeScale=1.35,Ha.update(i)),Kt.position.set(te.pos.x,gt(te.pos.x,te.pos.z)+(ci?Math.abs(Math.sin(te.runT))*.55:0),te.pos.z),Kt.rotation.y=Math.atan2(-te.dir.x,-te.dir.z)+(ci?0:PS),te.stompT-=i,te.stompT<=0){te.stompT=.26;const E=Math.hypot(te.pos.x-q.x,te.pos.z-q.z),w=Math.max(0,1-E/80);dt=Math.max(dt,.55*w),window.sStomp(.08+.36*w),Kn(te.pos.x,gt(te.pos.x,te.pos.z)+.5,te.pos.z,{n:8,color:4870728,sp:8,up:4,grav:8,life:.7,size:.7,spread:6,smoke:!0}),Bf(te.pos.x,te.pos.z),jt=Math.max(jt,.12*w)}for(let E=ct.length-1;E>=0;E--){const w=ct[E],y=w.mesh.position.x-te.pos.x,P=w.mesh.position.z-te.pos.z,N=Math.hypot(y,P)||1;N<9&&rs(E,y/N,P/N,!0)}if(!te.quakeDone&&Math.hypot(te.pos.x-q.x,te.pos.z-q.z)<30){te.quakeDone=!0,te.quake=!0,te.quakeR=2,te.qx=te.pos.x,te.qz=te.pos.z,Hn("🌋 THE BULL QUAKE"),window.sThunder(0),window.sHorn(),dt=1,jt=Math.max(jt,.3),Ui.visible=!0,Ui.position.set(te.qx,gt(te.qx,te.qz)+.4,te.qz);for(let E=0;E<3;E++)Bf(te.qx+(Math.random()-.5)*4,te.qz+(Math.random()-.5)*4);Kn(te.qx,gt(te.qx,te.qz)+.5,te.qz,{n:16,color:4870728,sp:12,up:6,grav:8,life:.9,size:.9,spread:8,smoke:!0})}Math.hypot(te.pos.x-q.x,te.pos.z-q.z)>160&&(te.active=!1,Kt.visible=!1)}else if(te.timer-=i,te.timer<=2.6&&te.warnT<=0&&te.timer>0&&(te.warnT=1,Hn("⚠ THE BLACK BULL SWEEP INCOMING"),window.sHorn(),dt=Math.max(dt,.35)),te.timer<=0){te.active=!0,te.timer=48+Math.random()*22;const _=Math.random()*Math.PI*2;te.pos.set(q.x+Math.cos(_)*110,0,q.z+Math.sin(_)*110),te.dir.set(q.x-te.pos.x+(Math.random()-.5)*14,0,q.z-te.pos.z+(Math.random()-.5)*14).normalize(),Kt.visible=!0,te.warnT=0,te.quakeDone=!1}if(te.quake){te.quakeR+=55*i,Ui.scale.setScalar(te.quakeR),Ui.material.opacity=.15+Math.max(0,.5*(1-te.quakeR/200)),dt=Math.max(dt,.22);for(let _=ct.length-1;_>=0;_--){const S=ct[_],E=S.mesh.position.x-te.qx,w=S.mesh.position.z-te.qz,y=Math.hypot(E,w)||1;y<te.quakeR&&rs(_,E/y,w/y,!0)}te.quakeR>200&&(te.quake=!1,Ui.visible=!1)}_t.visible=!(Pr>0&&Math.floor(Rt/4)%2===0);for(let _=jr.length-1;_>=0;_--){const S=jr[_];S.position.x+=S.userData.vx*i,S.position.z+=S.userData.vz*i,S.position.y+=S.userData.vy*i,S.userData.vy-=26*i,S.rotation.x+=S.userData.vr*i,S.userData.t-=i;const E=Math.max(0,S.userData.t/.7);S.userData.fm.uniforms.uD.value=1-E,Rt%2===0&&Mn(S.position.x,S.position.y+.6,S.position.z,7143344,1,2),(S.position.y<-3||S.userData.t<=0)&&(oe.remove(S),S.userData.fm.dispose(),jr.splice(_,1))}for(let _=Hi.length-1;_>=0;_--){const S=Hi[_];if(S.t-=i,S.mesh.rotation.z+=i*3,S.mesh.position.y=Ii(S.mesh.position.x,S.mesh.position.z,S.mesh.position.y)+1+Math.sin(Rt*.08+_)*.15,S.emoji&&S.emoji.position.set(S.mesh.position.x,S.mesh.position.y+.85,S.mesh.position.z),Math.hypot(S.mesh.position.x-q.x,S.mesh.position.z-q.z)<2){if(S.kind==="coin"){const w=3+Math.floor(ki/2);Ga(w),window.sCoin(),Fc("+"+w+" 🪙","#ffd75e"),Mn(S.mesh.position.x,S.mesh.position.y,S.mesh.position.z,16766814,8,4)}else S.kind==="power"?(h1(S.pk),Mn(S.mesh.position.x,S.mesh.position.y,S.mesh.position.z,to[S.pk].color,14,6)):(Di=Math.min(100,Di+15),window.sHeal(),Fc("+15 ❤️","#4ade80"));La(),oe.remove(S.mesh),S.emoji&&oe.remove(S.emoji),Hi.splice(_,1)}else S.t<=0&&(oe.remove(S.mesh),S.emoji&&oe.remove(S.emoji),Hi.splice(_,1))}La()}Ln.next-=e,Ln.next<=0&&(Ln.next=7+Math.random()*13,Ln.env=.9+Math.random()*.4,Ln.restrike=.09+Math.random()*.12,window.sThunder(.4+Math.random()*1.2),e1()),Ln.restrike>0&&(Ln.restrike-=e,Ln.restrike<=0&&(Ln.env=Math.max(Ln.env,.6+Math.random()*.5))),Ln.env=Math.max(0,Ln.env-e*4)*(.75+Math.random()*.25);const t=Math.min(1,Ln.env);if(Pa>0&&(Pa-=e,Om.opacity=Math.max(0,Pa/Qh)*(.6+Math.random()*.4),Pa<=0&&Ni&&(oe.remove(Ni),Ni.geometry.dispose(),Ni=null)),eh-=e,eh<=0){eh=14+Math.random()*20;const a=Math.random()*6.28,o=25+Math.random()*55,c=q.x+Math.cos(a)*o,l=q.z+Math.sin(a)*o,h=gt(c,l),u=new no(new xt().setFromPoints([new R(c+26,h+85,l-14),new R(c,h,l)]),new qc({color:new pe(1.6,3,2),transparent:!0,opacity:1,fog:!1}));oe.add(u),Yo.push({ln:u,t:.5,mx:c,mz:l,gy:h,hit:!1})}for(let a=Yo.length-1;a>=0;a--){const o=Yo[a];if(o.t-=e,o.ln.material.opacity=Math.max(0,o.t/.5),!o.hit&&o.t<.32){o.hit=!0,Kn(o.mx,o.gy+.4,o.mz,{n:10,color:5898144,sp:7,up:5,grav:9,life:.6,size:.5,spread:2}),Mn(o.mx,o.gy+1,o.mz,10354628,14,8);const c=Math.hypot(o.mx-q.x,o.mz-q.z);if(dt=Math.max(dt,Math.max(0,.5-c*.006)),window.sStomp(Math.max(.05,.3-c*.003)),jt=Math.max(jt,.08),Wt==="playing")for(let l=ct.length-1;l>=0;l--){const h=ct[l],u=h.mesh.position.x-o.mx,d=h.mesh.position.z-o.mz,f=Math.hypot(u,d)||1;f<4&&rs(l,u/f,d/f,!0)}}o.t<=0&&(oe.remove(o.ln),o.ln.geometry.dispose(),Yo.splice(a,1))}for(const a of wm){const o=a.wx-a.g.position.x,c=a.wz-a.g.position.z,l=Math.hypot(o,c);if(l<2){const d=Math.random()*Math.PI*2,f=15+Math.random()*70;a.wx=Math.cos(d)*f,a.wz=Math.sin(d)*f;continue}a.g.position.x+=o/l*a.sp*e,a.g.position.z+=c/l*a.sp*e;let u=((Math.atan2(o,c)-a.g.rotation.y+Math.PI)%(Math.PI*2)+Math.PI*2)%(Math.PI*2)-Math.PI;a.g.rotation.y+=u*Math.min(1,e*2),a.g.position.y=gt(a.g.position.x,a.g.position.z)+Math.abs(Math.sin(Rt*.06+a.ph))*.08,a.g.rotation.z=Math.sin(Rt*.06+a.ph)*.09}Xr.uniforms.flash.value=t,bn+=((Xs?1:0)-bn)*Math.min(1,e*1.5),Xr.uniforms.top.value.copy(C1).lerp(P1,bn),Xr.uniforms.bot.value.copy(L1).lerp(I1,bn),oe.fog.color.copy(D1).lerp(N1,bn),Jt.color.copy(O1).lerp(F1,bn),Bs.uniforms.uFlash.value=t*.3,am.intensity=Iu+t*1.2+bn*1.35,Jt.intensity=rm+t*.6+bn*.7,Am.color.setRGB(.086+t*.5,.14+t*.65,.106+t*.55).lerp(U1,bn*.9),nl.material.opacity=(1-t*.5)*(1-bn),Lm.opacity=Math.min(1,.75+t*.3),fm.emissiveIntensity=.34+Math.sin(Rt*.02)*.16+t*.4;const n=Math.sin(Rt*.0012)*.5+.5;oe.fog.far=lc.fogFar-n*55+t*30+bn*150,oe.fog.near=30-n*6,Nu.strength=(lc.bloom+n*.12+t*.25)*(1-bn*.5),jt*=Math.pow(.002,e),It.toneMappingExposure=lc.exposure-n*.05+Math.min(.35,jt)+bn*.13,Bs.uniforms.uT.value=(Bs.uniforms.uT.value+e)%10,Bs.uniforms.uHurt.value=Wt==="dead"?1:Math.min(1,(Di>0&&Di<=35?.45:0)+Math.max(0,Pr)*.9),ku.rotation.y+=e*.006,tl.offset.x+=e*.002,oo.rotation.y=Math.atan2(Nt.position.x,Nt.position.z+575);for(const a of Em)a.m.material.opacity=.42+Math.sin(Rt*.013+a.ph)*.14+t*.35,a.m.rotation.z=a.baseZ+Math.sin(Rt*.006+a.ph)*.05;const s=Gu.attributes.position;for(let a=0;a<Hu;a++){let o=s.getX(a)+(uc[a].x+Math.sin(Rt*.02+uc[a].ph)*.4)*e,c=s.getY(a)+uc[a].y*e,l=s.getZ(a);o-q.x>li/2&&(o-=li),o-q.x<-li/2&&(o+=li),c>Pm&&(c=1),l-q.z>li/2&&(l-=li),l-q.z<-li/2&&(l+=li),s.setXYZ(a,o,c,l)}s.needsUpdate=!0;for(const a of Dm){a.a+=a.sp*e;const o=q.x+Math.cos(a.a)*a.r,c=q.z+Math.sin(a.a)*a.r;a.s.position.set(o,gt(o,c)+1.2+Math.sin(Rt*.01+a.ph)*.4,c)}for(let a=0;a<rl;a++){const o=Um[a];if(!(!o||o.t<=0)){if(o.t-=e,o.t<=0){fs[a*3+1]=9999;continue}fs[a*3]+=o.vx*e,fs[a*3+1]+=o.vy*e,fs[a*3+2]+=o.vz*e,o.vy-=14*e}}co.attributes.position.needsUpdate=!0;for(const a of Vu){if(a.t<=0)continue;a.t-=e;const o=1-a.t/.55;a.m.scale.setScalar(3+o*22),a.m.material.opacity=.45*(1-o)*(1-o),a.t<=0&&(a.m.visible=!1)}for(const a of Mm){const o=.8+Math.sin(Rt*.22+a.ph)*.18+Math.random()*.15;a.s.scale.set(a.sc*o,a.sc*1.4*o,1)}for(const a of za){const o=a.x-q.x,c=a.z-q.z;a.d=o*o+c*c}za.sort((a,o)=>a.d-o.d);for(let a=0;a<qh.length;a++){const o=qh[a],c=za[a];if(c&&c.d<c.cull2){const l=.8+Math.sin(Rt*.28+c.ph)*.12+Math.random()*.1;o.position.set(c.x,c.y,c.z),o.color.setHex(c.color),o.distance=c.range,o.intensity=c.base*l}else o.intensity=0}for(const a of gm){const o=a.userData.flicker;o.t-=e,o.t<=0&&(o.on=!o.on||Math.random()<.5,o.t=o.on?.2+Math.random()*1.8:.05+Math.random()*.5,a.emissiveIntensity=o.on?.4+Math.random()*.8:.04)}for(let a=zs.length-1;a>=0;a--){const o=zs[a];if(o.t-=e,o.t<=0){oe.remove(o.m),zs.splice(a,1);continue}o.m.position.x+=o.vx*e,o.m.position.y+=o.vy*e,o.m.position.z+=o.vz*e,o.vy-=o.g*e;const c=o.t/o.life;o.m.scale.setScalar(o.smoke?o.s*(1+(1-c)*2.2):o.s*c)}const r=is;Nt.position.x+=(q.x+Math.sin(_n)*14-Nt.position.x)*Math.min(1,i*4),Nt.position.z+=(q.z+Math.cos(_n)*14-Nt.position.z)*Math.min(1,i*4),Nt.position.y+=(r+6.4-Os*3-Nt.position.y)*Math.min(1,i*3),dt>0&&(dt-=e*2,Nt.position.x+=(Math.random()-.5)*dt,Nt.position.y+=(Math.random()-.5)*dt*.7),Nt.lookAt(q.x-Math.sin(_n)*14,r+4+Os*13,q.z-Math.cos(_n)*14),Jt.position.set(q.x+42,58,q.z+18),Jt.target.position.set(q.x,0,q.z),om.position.set(q.x,3.2,q.z+.5),da.position.set(q.x,0,q.z),o1(i),NS()}let Is=0,oh=0,$o=0,ec=4e3,Qf=performance.now();const Zf=[0,0,0,0,0];function $f(i){Is=i;const e=[Math.min(devicePixelRatio,sn?1.6:2),1.25,1,1,1][i];It.setPixelRatio(e),ri.setPixelRatio(e),cm.enabled=i<2,Jt.castShadow=i<3,Nu.enabled=i<4}function t0(){if(requestAnimationFrame(t0),window.__frozen)return;const i=performance.now(),e=i-Qf;if(Qf=i,ec>0)ec-=e;else if(oh+=e,$o++,$o>=60){const t=oh/$o;oh=0,$o=0,t>37&&Is<4?($f(Is+1),ec=3e3):t<18&&Is>0&&Zf[Is]<2&&(Zf[Is]++,$f(Is-1),ec=8e3)}e0(window.__fixedDt||Math.min(T1.getDelta(),.05)),ri.render()}window.__step=i=>{for(let e=0;e<i;e++)e0(1/60)};window.__camTo=(i,e,t,n,s,r)=>{window.__frozen=!0,Nt.position.set(i,e,t),Nt.lookAt(n,s,r),ri.render()};window.__tp=(i,e,t)=>{q.x=i,q.z=t,Pe=e,it=0,ut=!1};window.__fieldTops=()=>Nn.filter(i=>i.botY!=null).map(i=>({x:i.x,z:i.z,topY:i.topY}));window.__bullPose=i=>{if(!window.__bullOk)return"bull not loaded";i=i||{},window.__frozen=!0,te.active=!1,Kt.visible=!0,Kt.position.set(0,0,0),Kt.rotation.y=i.yaw!=null?i.yaw:0,Kt.updateMatrixWorld(!0);const e=Kt.getObjectByName("Head"),t=new R;e.getWorldPosition(t);const n=i.dist!=null?i.dist:9,s=i.az||0;return Nt.position.set(t.x+Math.sin(s)*n,t.y+(i.dy!=null?i.dy:1),t.z+Math.cos(s)*n),Nt.lookAt(t.x,t.y+(i.look!=null?i.look:0),t.z),ri.render(),{head:t.toArray().map(r=>+r.toFixed(2))}};window.__shades=i=>{const e=Kt.getObjectByName("snoopShades");e&&(e.visible=!!i);const t=Kt.getObjectByName("snoopEyes");return t&&(t.visible=!i),ri.render(),!!i};t0();
